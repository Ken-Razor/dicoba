...
namespace LPS_BLL
{
    public class TxExec
    {
        ...
        public List<object> GetListExecChgAppr(string personnumber)
        {
            ...
            try
            {
                var data = DbTransaction.DbToList<object>("Usp_Get_ProjectExecChgAppr", oParameters, true);
                return data;
            }
            catch (Exception ex)
            {
        ...
        public DataSet Get_Exec_Detail(int IDPRoject, string Periode, string Persnum)
        {
            ...
            try
            {
                var data = DbTransaction.DbToDataSet("Usp_Get_PE_Detail", oParameters);
                return data;
            }
            catch (Exception ex)
            {
        ...
        public DataSet Get_Exec_Approval(int IDPRoject, string Periode, string Persnum)
        {
            ...
            try
            {
                var data = DbTransaction.DbToDataSet("Usp_Get_PE_Approval", oParameters);
                return data;
            }
            catch (Exception ex)
            {
        ...
        public DataSet Get_Exec_ApprovalLog(int IDPRoject, string Periode, string Persnum)
        {
            ...
            try
            {
                var data = DbTransaction.DbToDataSet("Usp_Get_PE_ApprovalLog", oParameters);
                return data;
            }
            catch (Exception ex)
            {
        ...
        public DataSet Get_Exec_Trend(int IDPRoject, string Periode, string Persnum)
        {
            ...
            try
            {
                var data = DbTransaction.DbToDataSet("Usp_Get_PE_Trend", oParameters);
                return data;
            }
            catch (Exception ex)
            {
        ...
        public DataSet Get_Exec_Procurement(int IDPRoject, string Periode, string Persnum)
        {
            ...
            try
            {
                var data = DbTransaction.DbToDataSet("Usp_Get_PE_Procurement", oParameters);
                return data;
            }
            catch (Exception ex)
            {
        ...
        public DataSet Get_Exec_Laporan(int IDPRoject, string Periode, string Persnum)
        {
            ...
            try
            {
                var data = DbTransaction.DbToDataSet("Usp_Get_PE_Laporan", oParameters);
                return data;
            }
            catch (Exception ex)
            {
