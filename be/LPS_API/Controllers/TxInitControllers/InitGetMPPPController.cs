...
{
    public class InitGetMPPPController : ApiController
    {
        ...
        public ProjectHeaderModel Put([FromBody]ProjectHeaderModel ph)
        {
            ...
            DataSet ds = ti.Get_TxPH_ByID_Timeline(ph.IDProjectHeader, ph.CreatedBy);
