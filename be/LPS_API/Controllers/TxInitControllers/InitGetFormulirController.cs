...
{
    public class InitGetFormulirController  : ApiController
    {
        ...
        public ProjectHeaderModel Put([FromBody]ProjectHeaderModel ph)
        {
            ...
            DataSet ds = ti.Get_TxPH_ByID_Formulir(ph.IDProjectHeader, ph.CreatedBy);
            ...
            DataTable dt15 = ds.Tables[14];
            DataTable dt16 = ds.Tables[15];
            //DataTable dt17 = ds.Tables[17];
            //DataTable dt18 = ds.Tables[18];
            DataTable dt19 = ds.Tables[16];
            DataTable dt20 = ds.Tables[17];
