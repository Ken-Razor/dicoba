...
{
    public class InitGetApprovalLogController : ApiController
    {
        ...
        public ProjectHeaderModel Put([FromBody]ProjectHeaderModel ph)
        {
            ...
            DataSet ds = ti.Get_TxPH_ByID_ApprovalLog(ph.IDProjectHeader, ph.CreatedBy);
            ...
            DataTable dt18 = ds.Tables[2];
            DataTable dt19 = ds.Tables[3];
