...
{
    public class ExecCRUDApprovalController : ApiController
    {
        GlobalFunction GF = new GlobalFunction();
        TxExec TE = new TxExec();
        public EksekusiModel Get(int ProjectID, string Periode, string Persnum)
        {
            DataSet ds = TE.Get_Exec_Approval(ProjectID, Periode, Persnum);
            ...
            DataTable roleuser = ds.Tables[4];
            DataTable Sysrole = ds.Tables[5];
            DataTable Status = ds.Tables[6];
