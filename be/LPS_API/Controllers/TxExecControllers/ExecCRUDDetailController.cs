...
{
    public class ExecCRUDDetailController : ApiController
    {
        GlobalFunction GF = new GlobalFunction();
        TxExec TE = new TxExec();
        public EksekusiModel Get(int ProjectID, string Periode, string Persnum)
        {
            DataSet ds = TE.Get_Exec_Detail(ProjectID, Periode, Persnum);
            ...
            DataTable revisidesc = ds.Tables[5];
            DataTable History = ds.Tables[6];
            DataTable roleuser = ds.Tables[7];
            DataTable Sysrole = ds.Tables[8];
            DataTable Status = ds.Tables[9];
