...
{
    public class ExecCRUDLaporanController : ApiController
    {
        GlobalFunction GF = new GlobalFunction();
        TxExec TE = new TxExec();
        public EksekusiModel Get(int ProjectID, string Periode, string Persnum)
        {
            DataSet ds = TE.Get_Exec_Laporan(ProjectID, Periode, Persnum);
            ...
            DataTable YearlyDocument = ds.Tables[7];
