...
{
    public class ExecCRUDTrendController : ApiController
    {
        GlobalFunction GF = new GlobalFunction();
        TxExec TE = new TxExec();
        public EksekusiModel Get(int ProjectID, string Periode, string Persnum)
        {
            DataSet ds = TE.Get_Exec_Trend(ProjectID, Periode, Persnum);

            //DataTable milestone = ds.Tables[0];
            DataTable constrain = ds.Tables[0];
            DataTable status = ds.Tables[1];
            DataTable approval = ds.Tables[2];
            DataTable isApproval = ds.Tables[3];
            //DataTable rolegroup = ds.Tables[4];
            DataTable revisidesc = ds.Tables[4];
            //DataTable History = ds.Tables[6];
            DataTable roleuser = ds.Tables[5];
            DataTable Sysrole = ds.Tables[6];
            DataTable Status = ds.Tables[7];
            //DataTable StatusProject = ds.Tables[11];
            //DataTable dt14 = ds.Tables[13];
            ...
            //DataTable YearlyDocument = ds.Tables[12];
