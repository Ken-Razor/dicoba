...
{
    public class EmailTransNoRealController : ApiController
    {
        public string Get(string username)
        {
            try
            {
                ...
                DataSet DS = IS.GetEmailDataTransNoReal(username);
                ...
                if (dtsedikit.Rows.Count > 0)
                {
                    ...
                    var EmailSubject = "Daftar Penyampaian Realisasi Project Transformas";
