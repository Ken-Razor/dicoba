...
namespace LPS_DAL
{
    public class DbTransaction
    {
        ...
        /// </summary>
        private static string SqlConnectionString = ConfigurationManager.ConnectionStrings["DB_ConnectionString"].ConnectionString;
        ...
        public static void DbExecute(string Query, bool IsStorageProcedure)
        {
            using (var sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    sqlConnection.Execute(Query, commandType: CommandType.StoredProcedure, commandTimeout: 1800);
            }
        }
        ...
        public static void DbExecute(string Query, object Parameter, bool IsStorageProcedure)
        {
            using (var sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    sqlConnection.Execute(Query, Parameter, commandType: CommandType.StoredProcedure, commandTimeout: 1800);
        ...
        public static string DbToString(string Query, bool IsStorageProcedure)
        {
            using (var sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<string>(Query, commandType: CommandType.StoredProcedure, commandTimeout: 1800).FirstOrDefault();
            }
        }
        ...
        public static string DbToString(string Query, object Parameter, bool IsStorageProcedure)
        {
            using (var sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<string>(Query, Parameter, commandType: CommandType.StoredProcedure, commandTimeout: 1800).FirstOrDefault();
            }
        }
        #endregion
        ...
        public static int DbToInt(string Query, bool IsStorageProcedure)
        {
            using (var sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<int>(Query, commandType: CommandType.StoredProcedure, commandTimeout: 1800).FirstOrDefault();
            }
        }
        ...
        public static int DbToInt(string Query, object Parameter, bool IsStorageProcedure)
        {
            using (var sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<int>(Query, Parameter, commandType: CommandType.StoredProcedure, commandTimeout: 1800).FirstOrDefault();
            }
        }
        #endregion
        ...
        public static List<T> DbToList<T>(string Query, bool IsStorageProcedure)
        {
            using (SqlConnection sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<T>(Query, commandType: CommandType.StoredProcedure, commandTimeout: 1800).ToList();
            }
        }
        ...
        public static List<T> DbToList<T>(string Query, object Parameter, bool IsStorageProcedure)
        {
            using (SqlConnection sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<T>(Query, Parameter, commandType: CommandType.StoredProcedure, commandTimeout: 1800).ToList();
            }
        }
        #endregion
        ...
        private static SqlParameter[] ObjetToSqlParameter(object dataObject)
        {
            ...
            for (int i = 0; i < props.Length; i++)
            {
                ...
                if (props[i].PropertyType.IsValueType || props[i].PropertyType.Name == "String" || props[i].PropertyType.Name == "Object" || props[i].PropertyType.Name == "DataTable")
                {
        ...
        public static dynamic DbToDynamic(string Query, bool IsStorageProcedure)
        {
            using (SqlConnection sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<dynamic>(Query, commandType: CommandType.StoredProcedure, commandTimeout: 1800).ToList();
            }
        }
        ...
        public static dynamic DbToDynamic(string Query, object Parameter, bool IsStorageProcedure)
        {
            using (SqlConnection sqlConnection = new SqlConnection(SqlConnectionString))
            {
                ...
                if (!IsStorageProcedure)
                    ...
                    return sqlConnection.Query<dynamic>(Query, Parameter, commandType: CommandType.StoredProcedure, commandTimeout: 1800).ToList();
            }
        }
        #endregion
        ...
        public DataTable GetDataTablefromDT(string strStoredProcedureName, string dtparam, DataTable dt)
        {
            ...
            try
            {
                ...
                sqlCmd = new SqlCommand(strStoredProcedureName, sqlConn);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.AddWithValue(dtparam, dt);
