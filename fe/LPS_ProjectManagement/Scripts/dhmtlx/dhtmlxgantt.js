...
Gantt.getGanttInstance = function() {
    ...
    t.copy = function(e) {
        ...
        if (e && "object" == typeof e) {
            ...
            i = 0; i < n.length; i++)
                e instanceof n[i] && (a = i ? new n[i](e) : new n[i]);
            for (i in e)
                Object.prototype.hasOwnProperty.apply(e, [i]) && (a[i] = t.copy(e[i]))
        }
        return a || e
    }
    ,
    ...
    t._on_contextmenu = function(e) {
        ...
        return s || (e.preventDefault ? e.preventDefault() : e.returnValue = !1),
        s
    }
    ,
    ...
    t._DnD.prototype = {
        dragStart: function(e, i) {
            ...
            t.bind(function(e) {
              ...
              , s = t.bind(function(i) {
                return t.eventRemove(document.body, "mousemove", a),
                t.eventRemove(document.body, "mouseup", s),
                this.dragEnd(e)
            }, this);
            t.event(document.body, "mousemove", a),
            t.event(document.body, "mouseup", s),
    ...
    t._render_grid_item = function(e) {
        ...
        for (var i = this.getGridColumns(), n = [], a = 0; a < i.length; a++) {
            ...
            r instanceof Date && (r = this.templates.date_grid(r, e)),
            r = "<div class='gantt_tree_content'>" + r + "</div>");
            ...
            if (_.tree) {
                ...
                c ? (l += this.templates.grid_open(e),
                l += this.templates.grid_folder(e)) : (l += this.templates.grid_blank(e),
                l += this.templates.grid_file(e))
            }
            var u = "width:" + (_.width - (o ? 1 : 0)) + "px;";
            this.defined(_.align) && (u += "text-align:" + _.align + ";"),
            s = "<div class='" + d + "' style='" + u + "'>" + l + r + "</div>",
            n.push(s)
        }
        var d = e.$index % 2 === 0 ? "" : " odd";
        if (d += e.$transparent ? " gantt_transparent" : "",
        d += e.$dataprocessor_class ? " " + e.$dataprocessor_class : "",
        ...
        f.style.lineHeight = t.config.row_height + "px",
    ...
    t._set_item_state = function(e, i) {
        e && this._pull[e] && (this._pull[e].$open = i,
        t._refresh_on_toggle_element(e))
    }
    ,
    ...
    t.moveTask = function(e, i, n) {
        ...
        if (e != n) {
            ...
            var s = this.getTask(e)
              ...
              , o = (this.getChildren(this.getParent(s.id)),
            this.getChildren(n));
            if (-1 == i && (i = o.length + 1),
            r == n) {
    ...
    t._init_dnd = function() {
        ...
        e.attachEvent("onBeforeDragStart", this.bind(function(i, n) {
            ...
            var s = this.locate(n)
              , r = t.getTask(s);
            return t._is_readonly(r) ? !1 : (e.config.initial_open_state = r.$open,
            this.callEvent("onRowDragStart", [s, n.target || n.srcElement, n]) ? void 0 : !1)
        }, this)),
        ...
        e.lastTaskOfLevel = function(e) {
            for (var i = t._order, n = t._pull, a = null , s = 0, r = i.length; r > s; s++)
                n[i[s]].$level == e && (a = n[i[s]]);
            return a ? a.id : null 
        }
        ,
        e._getGridPos = this.bind(function(t) {
            var e = this._get_position(this.$grid_data)
              ...
              , n = t.pos.y - 10;
            return n < e.y && (n = e.y),
            n > e.y + this.$grid_data.offsetHeight - this.config.row_height && (n = e.y + this.$grid_data.offsetHeight - this.config.row_height),
            e.x = i,
            e.y = n,
            e
        }, this),
        e.attachEvent("onDragMove", this.bind(function(i, n) {
            ...
            var s = e.config
              , r = e._getGridPos(n);
            s.marker.style.left = r.x + 10 + "px",
            s.marker.style.top = r.y + "px",
            r = e._getGridPos(n);
            var o = (r.x,
            r.y)
            ...
            if (this.isTaskExists(h) || (h = e.lastTaskOfLevel(t.config.order_branch_free ? c.$level : 0),
            h == e.config.id && (h = null )),
            this.isTaskExists(h)) {
                ...
                if (u.y + l.offsetHeight / 2 < o) {
                    ...
                    if (p) {
                        if (p.id == c.id)
                            return;
                        g = p
                    } else if (p = this._pull[this._order[f]],
                    a(p, c) && p.id != c.id)
                        return void this.moveTask(c.id, -1, this.getParent(p.id))
                }
                for (var f = this.getGlobalTaskIndex(g.id), v = this._pull[this._order[f - 1]], m = 1; (!v || v.id == g.id) && f - m >= 0; )
                    v = this._pull[this._order[f - m]],
                    m++;
                if (c.id == g.id)
                    return;
        ...
        e.attachEvent("onDragEnd", this.bind(function() {
            ...
            this.callEvent("onBeforeRowDragEnd", [e.config.id, e.config.parent, e.config.index]) === !1 ? (this.moveTask(e.config.id, e.config.index, e.config.parent),
    ...
    t._render_grid_header_resize = function() {
        for (var t = this.getGridColumns(), e = 0, i = this.config.scale_height, n = (this._get_position(this.$grid_scale),
        0); n < t.length; n++) {
            var a = (n == t.length - 1,
            t[n]);
            if (e += a.width,
    ...
    t._init_resize = function() {
        ...
        e.attachEvent("onDragMove", this.bind(function(i, n) {
            var a = e.config
              ...
              , h = 0;
            o -= r.x - 1;
            for (var c = 0; c < a.drag_index; c++)
                _ += s[c].width,
                l += s[c].width;
            return _ > o && (o = _),
            this.config.keep_grid_width && o > d && (o = d),
            h = o - l,
            a.marker.style.top = r.y + "px",
            a.marker.style.left = r.x - 1 + l + "px",
            a.marker.style.width = h + "px",
            a.left = o - 1,
            t.callEvent("onColumnResize", [a.drag_index, s[a.drag_index], h - 1]),
            !0
        }, this)),
        e.attachEvent("onDragEnd", this.bind(function(i, n) {
            for (var a = this.getGridColumns(), s = 0, r = parseInt(e.config.drag_index, 10), o = a[r], _ = 0; r > _; _++)
                s += a[_].width;
            ...
            if (t.callEvent("onColumnResizeEnd", [r, o, d]) !== !1 && o.width != d) {
                ...
                this.config.keep_grid_width)
                    for (var _ = r + 1, l = a.length; l > _; _++)
                        "add" == a[_].name ? a[_].width = 1 * a[_].width || 44 : a[_].width = null ;
                else {
                    for (var _ = r, l = a.length; l > _; _++)
                        s += a[_].width;
        ...
        this.defined(this.config.dnd_sensitivity) && (i.config.sensitivity = this.config.dnd_sensitivity),
        i.attachEvent("onBeforeDragStart", this.bind(function(e, i) {
        ...
        i.attachEvent("onAfterDragStart", this.bind(function(t, e) {
            i.config.marker.innerHTML = "",
            i.config.marker.className += " gantt_grid_resize_area",
            i.config.marker.style.height = this.$grid.offsetHeight + "px",
            i.config.marker.style.top = "0px"
        }, this)),
        i.attachEvent("onDragMove", this.bind(function(e, n) {
            for (var a = i.config, s = this.config.columns, r = this._get_position(this.$grid), o = parseInt(a.marker.style.left, 10), _ = 0, d = 0; d < s.length; d++)
                s[d].hide || (_ += s[d].min_width ? s[d].min_width : this.config.min_grid_column_width);
            return o -= r.x - 1,
            _ > o && (o = _),
            a.marker.style.top = r.y + "px",
            a.marker.style.left = r.x - 1 + "px",
            a.marker.style.width = o + "px",
            a.left = o - 1,
            t.callEvent("onGridResize", [this.config.grid_width, o - 1]),
            !0
        }, this)),
        i.attachEvent("onDragEnd", this.bind(function(e, n) {
            for (var a = this.config.columns, s = 0, r = i.config.left, o = 0, _ = a.length; _ > o; o++)
                a[o].hide || (s += a[o].width);
            for (var d, l = a.length, h = r - s, o = 0; l > o; o++)
                if (!a[o].hide) {
                    var c = Math.floor(h * (a[o].width / s));
                    s -= a[o].width,
                    d = a[o].width + c,
                    (a[o].min_width && d >= a[o].min_width || !a[o].min_width || d > a[o].width) && (h -= c,
                    a[o].width = d)
                }
            for (var u = h > 0 ? 1 : -1; h > 0 && 1 === u || 0 > h && -1 === u; ) {
                ...
                for (o = 0; l > o; o++) {
                    var f = a[o].width + u;
                    if ((a[o].min_width && f >= a[o].min_width || !a[o].min_width || d > a[o].width) && (h -= u,
                    a[o].width = f,
                    0 === h))
                        break
                }
    ...
    t.getGridColumns = function() {
        for (var e = t.config.columns, i = [], n = 0; n < e.length; n++)
            e[n].hide || i.push(e[n]);
        return i
    }
    ,
    ...
    t._scale_helpers = {
        ...
        prepareConfigs: function(t, e, i, n) {
            for (var a = this.splitSize(n, t.length), s = i, r = [], o = t.length - 1; o >= 0; o--) {
                ...
                _ && this.processIgnores(d),
                this.initColSizes(d, e, s, a[o]),
                this.limitVisibleRange(d),
                _ && (s = d.full_width),
                r.unshift(d)
            }
        ...
        setPosSettings: function(t) {
            for (var e = 0, i = t.trace_x.length; i > e; e++)
        ...
        iterateScales: function(t, e, i, n, a) {
            for (var s = e.trace_x, r = t.trace_x, o = i || 0, _ = n || r.length - 1, d = 0, l = 1; l < s.length; l++)
                for (var h = o; _ >= h; h++)
                    +r[h] != +s[l] || (a && a.apply(this, [d, l, o, h]),
                    o = h,
                    d = l)
        },
        ...
        eachColumn: function(e, i, n) {
            ...
            for (+r >= +s && (s = t.date.add(r, i, e)); +s > +r; ) {
                ...
                r = t.date.add(r, i, e),
                r = t._correct_dst_change(r, o, i, e),
                t.date[e + "_start"] && (r = t.date[e + "_start"](r))
            }
        },
    ...
    t._scale_helpers.processIgnores = function(e) {
        ...
        t.ignore_time || t.config.skip_off_time) {
            ...
            for (var a = 0; a < e.trace_x.length; a++)
                n.call(t, e.trace_x[a]) || this._ignore_time_config.call(t, e.trace_x[a]) ? (e.ignore_x[e.trace_x[a].valueOf()] = !0,
                e.ignored_colls = !0) : i++
        }
        e.display_count = i
    }
    ...
    t._tasks_dnd = {
        ...
        _resize: function(e, i, n) {
            ...
            n.left ? (e.start_date = t.dateFromPos(s.start + i),
            e.start_date || (e.start_date = new Date(t.getState().min_date))) : (e.end_date = t.dateFromPos(s.end + i),
            e.end_date || (e.end_date = new Date(t.getState().max_date))),
            e.end_date - e.start_date < a.min_duration && (n.left ? e.start_date = t.calculateEndDate(e.end_date, -1) : e.end_date = t.calculateEndDate(e.start_date, 1)),
        ...
        _move: function(e, i, n) {
            ...
            s ? r ? (e.start_date = s,
            e.end_date = r) : (e.end_date = new Date(t.getState().max_date),
        ...
        _update_on_move: function(e) {
            ...
            if (i.mode) {
                ...
                if (this._handlers[i.mode]) {
                    var o = t.mixin({}, r)
                      , _ = t.mixin({}, r);
                    this._handlers[i.mode].apply(this, [_, s, i]),
                    t.mixin(r, _, !0),
                    t.callEvent("onTaskDrag", [r.id, i.mode, _, o, e]),
                    t.mixin(r, _, !0),
        ...
        on_mouse_down: function(e, i) {
            if (2 != e.button) {
                var n = t.locate(e)
                  , a = null ;
                if (t.isTaskExists(n) && (a = t.getTask(n)),
                !t._is_readonly(a) && !this.drag.mode) {
                    this.clear_drag_state(),
                    i = i || e.target || e.srcElement;
                    var s = t._getClassName(i);
                    if (!s || !this._get_drag_mode(s))
                        return i.parentNode ? this.on_mouse_down(e, i.parentNode) : void 0;
                    var r = this._get_drag_mode(s);
                    if (r)
                        if (r.mode && r.mode != t.config.drag_mode.ignore && t.config["drag_" + r.mode]) {
                            if (n = t.locate(i),
                            a = t.copy(t.getTask(n) || {}),
                            t._is_readonly(a))
                                return this.clear_drag_state(),
                                !1;
                            if (t._is_flex_task(a) && r.mode != t.config.drag_mode.progress)
                            ...
                            r.start_y = o.y,
                            r.obj = a,
                            this.drag.start_drag = r
                        } else
                            this.clear_drag_state();
                    else if (t.checkEvent("onMouseDown") && t.callEvent("onMouseDown", [s.split(" ")[0]]) && i.parentNode)
                        return this.on_mouse_down(e, i.parentNode)
                }
            }
        },
        _fix_dnd_scale_time: function(e, i) {
            ...
            var s = t._tasks.unit
              , r = t._tasks.step;
            t.config.round_dnd_dates || (s = "minute",
            r = t.config.time_step),
            ...
            n(e),
            e.end_date = t.calculateEndDate(e.start_date, e.duration, t.config.duration_unit))
        },
        ...
        on_mouse_up: function(e) {
            ...
            if (i.mode && i.id) {
                ...
                this._fix_dnd_scale_time(n, i),
                t._init_task_timing(n),
                this._fireEvent("before_finish", i.mode, [i.id, i.mode, t.copy(i.obj), e])) {
                    var a = i.id;
                    t._init_task_timing(n),
                    this.clear_drag_state(),
                    t.updateTask(n.id),
        ...
        _get_drag_mode: function(e) {
            ...
            case "gantt_task_drag":
                s.mode = i.resize,
                n[1] && -1 !== n[1].indexOf("left", n[1].length - "left".length) ? s.left = !0 : s.left = !1;
                break;
    ...
    t._render_link = function(e) {
        for (var i = this.getLink(e), n = t._get_link_renderers(), a = 0; a < n.length; a++)
            n[a].render_item(i);
    }
    ,
    ...
    t._render_link_element = function(e) {
        ...
        for (var _ = 0; _ < a.length; _++) {
            ...
            e.color && (d.firstChild.style.backgroundColor = e.color),
            s.appendChild(d)
        }
        var l = a[a.length - 1].direction
          , h = t._render_link_arrow(i[i.length - 1], l);
        return e.color && (h.style.borderColor = e.color),
        s.appendChild(h),
        s
    }
    ,
    t._render_link_arrow = function(e, i) {
        ...
        return n.style.cssText = ["top:" + s + "px", "left:" + r + "px"].join(";"),
        n.className = d,
        n
    }
    ,
    t._drawer = {
        ...
        get_wrapper_sizes: function(e) {
            var i, n = t.config.link_wrapper_width, a = (t.config.link_line_width,
            e.y + (t.config.row_height - n) / 2);
            switch (e.direction) {
            case this.dirs.left:
                i = {
                    top: a,
    ...
    t._path_builder = {
        ...
        point: function(e) {
            return e ? (this.path.push(t.copy(e)),
            e) : this.current()
        },
        ...
        get_points: function(e) {
            ...
            var o = 2 * n.link_arrow_size
              , _ = i.e_x > i.x;
            if (e.type == t.config.links.start_to_start)
                this.point_to(r.left, o),
                _ ? (this.point_to(r.down, a),
                this.point_to(r.right, s)) : (this.point_to(r.right, s),
                this.point_to(r.down, a)),
                ...
                _)
                    s -= o,
                    this.point_to(r.down, a),
                    this.point_to(r.right, s);
                else {
                    s -= 2 * o;
                    var d = a > 0 ? 1 : -1;
                    this.point_to(r.down, d * (n.row_height / 2)),
                    this.point_to(r.right, s),
                    this.point_to(r.down, d * (Math.abs(a) - n.row_height / 2)),
                    this.point_to(r.right, o)
                }
            else if (e.type == t.config.links.finish_to_finish)
                this.point_to(r.right, o),
                _ ? (this.point_to(r.right, s),
                this.point_to(r.down, a)) : (this.point_to(r.down, a),
                this.point_to(r.right, s)),
                this.point_to(r.left, o);
        ...
        get_endpoint: function(e) {
            ...
            a = !0) : e.type == i.start_to_finish ? (n = !0,
    ...
    t._init_links_dnd = function() {
        function e(e, i, n) {
            ...
            return a.y += t._get_task_height() / 2,
            n = n || 0,
            a.x += (i ? -1 : 1) * n,
            a
        }
        ...
        function d() {
            ...
            t.$task_links.appendChild(h._direction)),
            h._direction
        }
        function l() {
        ...
        h.attachEvent("onAfterDragStart", t.bind(function(t, e) {
            i(h.config.marker)
        }, this)),
        h.attachEvent("onDragMove", t.bind(function(a, s) {
            var o = h.config
              , _ = h.getPosition(s);
            n(o.marker, _);
            var d = t._is_link_drop_area(s)
              ...
              , p = t.locate(s)
              , v = !0;
            if (d && (v = !t._locate_css(s, u),
            d = !!p),
            t._link_target_task = p,
            t._link_landing = d,
            t._link_target_task_start = v,
            d) {
                var m = t.getTask(p)
                  , k = t._locate_css(s, f)
                  , b = 0;
                ...
                this._dir_end = t._get_mouse_pos(s);
            var y = !(c == d && l == p && g == v);
            return y && (l && t.refreshTask(l, !1),
            p && t.refreshTask(p, !1)),
            y && i(o.marker),
            r(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y),
            !0
        }, this)),
        h.attachEvent("onDragEnd", t.bind(function() {
            var e = a();
            ...
            s(),
            e.from && t.refreshTask(e.from, !1),
            e.to && t.refreshTask(e.to, !1),
            l()
        }, this)),
    ...
    t._task_renderer = function(e, i, n, a) {
        ...
        this._task_area_renderers[e] = {
            ...
            append: function(t, e, i) {
                e && (this.rendered[t.id] && this.rendered[t.id].parentNode ? this.replace_item(t.id, e) : i.appendChild(e),
    ...
    t._init_tasks = function() {
        ...
        this._dbl_click.gantt_link_point = this.bind(function(e, i, n) {
            ...
            s && this._delete_link_handler(s, e),
            !1
        }, this),
        ...
        this._onTaskIdChange = this.attachEvent("onTaskIdChange", function(t, i) {
            var n = this._get_task_renderers();
            e(n, t, i, this.getTask(i))
        }),
        this._onLinkIdChange && this.detachEvent(this._onLinkIdChange),
        this._onLinkIdChange = this.attachEvent("onLinkIdChange", function(t, i) {
    ...
    t._filter_task = function(t, e) {
        ...
        n = this.config.end_date.valueOf(),
        +e.start_date > n || +e.end_date < +i) ? !1 : !0
    }
    ,
    ...
    t._render_data = function() {
        ...
        this._is_render_active()) {
            ...
            this._scroll_resize();
            for (var e = this._get_tasks_data(), i = this._get_task_renderers(), n = 0; n < i.length; n++)
                i[n].render_items(e);
    ...
    t._update_layout_sizes = function() {
        ...
        if (this._is_grid_visible()) {
            for (var r = this.getGridColumns(), o = 0, n = 0; n < r.length; n++)
                o += r[n].width;
    ...
    t._prepare_scale_html = function(e) {
        var i = []
          ...
          , a = null 
          , s = null ;
        (e.template || e.date) && (a = e.template || this.date.date_to_str(e.date)),
        s = e.css || function() {}
        ,
        !e.css && this.config.inherit_scale_class && (s = t.templates.scale_cell_class);
        for (var r = 0; r < e.count; r++) {
            ...
            if (_) {
                d = "width:" + _ + "px;",
                h = "gantt_scale_cell" + (r == e.count - 1 ? " gantt_last_cell" : ""),
                l = s.call(this, n),
                l && (h += " " + l);
        ...
        if (this._is_chart_visible()) {
            ...
            for (var r = this._get_resize_options(), o = r.x ? Math.max(this.config.autosize_min_width, 0) : this.$task.offsetWidth, _ = a.prepareConfigs(s, this.config.min_column_width, o, n), d = this._tasks = _[_.length - 1], l = [], h = this.templates.scale_row_class, c = 0; c < _.length; c++) {
                var u = "gantt_scale_line"
                  , g = h(_[c]);
                g && (u += " " + g),
                l.push('<div class="' + u + '" style="height:' + _[c].height + "px;line-height:" + _[c].height + 'px">' + this._prepare_scale_html(_[c]) + "</div>")
            }
            t = l.join(""),
            e = d.full_width + this.$scroll_ver.offsetWidth + "px",
            i = d.full_width + "px",
            n += "px"
        }
    ...
    t._render_bg_line = function(e) {
        ...
        if (t.config.show_task_cells)
            for (var s = 0; n > s; s++) {
                ...
                if (r > 0) {
                    ...
                    l = this.templates.task_cell_class(e, i.trace_x[s]),
                    l && (o += " " + l),
                    _.className = o,
                    a.appendChild(_)
                }
        ...
        a.className = h,
        t.config.smart_rendering && (a.style.position = "absolute",
        a.style.top = this.getTaskTop(e.id) + "px",
        a.style.width = "100%"),
        ...
        if (this._is_render_active()) {
            ...
            if (a && this.isTaskVisible(e)) {
                ...
                for (var s = 0; s < a.$source.length; s++)
                    t.refreshLink(a.$source[s]);
                for (var s = 0; s < a.$target.length; s++)
                    t.refreshLink(a.$target[s])
            }
        }
    }
    ,
    t.refreshLink = function(t) {
        if (this._is_render_active())
            if (this.isLinkExists(t))
                ...
                for (var e = this._get_link_renderers(), i = 0; i < e.length; i++)
                    e[i].remove_item(t)
    }
    ,
    t._combine_item_class = function(e, i, n) {
        ...
        this._is_flex_task(r) && a.push("gantt_dependent_task"),
        this.config.select_task && n == s.selected_task && a.push("gantt_selected"),
        n == s.drag_id && (a.push("gantt_drag_" + s.drag_mode),
        s.touch_drag && a.push("gantt_touch_" + s.drag_mode));
        var o = t._get_link_state();
        if (o.link_source_id == n && a.push("gantt_link_source"),
        o.link_target_id == n && a.push("gantt_link_target"),
        ...
        o.link_landing_area && o.link_target_id && o.link_source_id && o.link_target_id != o.link_source_id) {
            var _ = o.link_source_id
              ...
              , c = "";
            c = h ? l ? "link_start_allow" : "link_finish_allow" : l ? "link_start_deny" : "link_finish_deny",
            a.push(c)
        }
        return a.join(" ")
    }
    ...
    t._task_default_render = function(e) {
        if (!this._isAllowedUnscheduledTask(e)) {
            ...
            e.textColor && (d.style.color = e.textColor),
            r.appendChild(d);
            ...
            c && r.appendChild(c),
            this._is_readonly(e) || (n.drag_resize && !this._is_flex_task(e) && _ != this.config.types.milestone && t._render_pair(r, "gantt_task_drag", e, function(t) {
            ...
            n.drag_links && this.config.show_links && t._render_pair(r, "gantt_link_control", e, function(t) {
                var e = document.createElement("div");
                e.className = t,
                e.style.cssText = ["height:" + a + "px", "line-height:" + a + "px"].join(";");
                var i = document.createElement("div");
                return i.className = "gantt_link_point",
                e.appendChild(i),
                e
            })),
            r
    ...
    t._render_task_progress = function(e, i, n) {
        ...
        var s = document.createElement("div")
          , r = Math.round(n * a);
        if (r = Math.min(n, r),
        e.progressColor && (s.style.backgroundColor = e.progressColor,
        s.style.opacity = 1),
        s.style.width = r + "px",
        s.className = "gantt_task_progress",
        s.innerHTML = this.templates.progress_text(e.start_date, e.end_date, e),
        i.appendChild(s),
    ...
    t.dateFromPos = function(e) {
        var i = this._tasks;
        if (0 > e || e > i.full_width || !i.full_width)
            return null ;
    ...
    t.posFromDate = function(e) {
        ...
        a && (s += n < t._tasks.width.length ? t._tasks.width[n] * (a % 1) : 1),
        s
    }
    ,
    t._day_index_by_date = function(e) {
        ...
        if (i >= this._max_date)
            return n.length;
        for (var s = t._findBinary(n, i), r = +t._tasks.trace_x[s]; a[r]; )
            r = t._tasks.trace_x[++s];
    ...
    t._render_bg_canvas = function() {
        function e() {
            for (var e = t._tasks.width, i = {}, n = 0; n < e.length; n++)
                1 * e[n] && (i[e[n]] = !0);
            return i
        }
        function i(e, i) {
            ...
            s.lineTo(e, n),
            s.lineWidth = r,
            s.strokeStyle = i.bottomBorderColor || "#ebebeb",
            s.stroke(),
            s.beginPath();
            ...
            s.lineTo(e, 0),
            s.lineWidth = o,
            s.strokeStyle = i.rightBorderColor || "#ebebeb",
            s.stroke(),
            a.toDataURL()
        }
        function n(t) {
        ...
        function a(e) {
            for (var i, n, a = [], s = 0, r = t._tasks.width.filter(function(t) {
                ...
                if (_ != n && void 0 !== n || o == r.length - 1) {
                    i = document.createElement("div"),
                    i.style.height = t.config.row_height * t._order.length + "px",
                    i.style.cssFloat = "left",
                    i.style.whiteSpace = "no-wrap",
                    i.style.backgroundImage = "url(" + e[n || _] + ")";
                    var d = s;
                    o == r.length - 1 && (d = _ + d - 1),
                    i.style.width = d + "px",
                    s = 0,
                    a.push(i)
                }
    ...
    t._layers = {
        ...
        create: function(e, i) {
            return {
                ...
                add: function(e) {
                    if (e && this.tempCollection.push(e),
                    this.container())
                        for (var n = this.container(), a = this.tempCollection, s = 0; s < a.length; s++) {
                            ...
                            this.renderers[o] = t._task_renderer(o, e.renderer, r, e.filter),
                            this.tempCollection.splice(s, 1),
                            s--
                        }
                },
                remove: function(t) {
    ...
    t.load = function(e, i, n) {
        ...
        s = n) : "string" == typeof arguments[1] ? a = arguments[1] : "function" == typeof arguments[1] && (s = arguments[1]),
        this._load_type = a,
    ...
    t._load_task = function(t) {
        ...
        this.callEvent("onTaskLoading", [t]) ? (this._pull[t.id] = t,
        !0) : !1
    }
    ,
    ...
    t._build_hierarchy = function(t) {
        for (var e = null , i = 0, n = t.length; n > i; i++)
            e = t[i],
    ...
    t._sync_order_item = function(t, e) {
        t.id && (this._order_full.push(t.id),
        !e && this._filter_task(t.id, t) && this.callEvent("onBeforeTaskDisplay", [t.id, t]) && (this._order.push(t.id),
        this._order_search[t.id] = this._order.length - 1));
        var i = this.getChildren(t.id);
        if (i)
            for (var n = 0; n < i.length; n++)
                this._sync_order_item(this._pull[i[n]], e || !t.$open);
    }
    ,
    ...
    t.eachTask = function(t, e, i) {
        ...
        if (n)
            for (var a = 0; a < n.length; a++) {
                ...
                t.call(i, s),
                this.hasChild(s.id) && this.eachTask(t, s.id, i)
            }
    }
    ,
    t.json = {
        ...
        _copyObject: function(e) {
            ...
            for (var n in e)
                "$" != n.charAt(0) && (i[n] = e[n],
                i[n] instanceof Date && (i[n] = t.templates.xml_format(i[n])));
            return i
        },
        serialize: function() {
            var e = []
    ...
    t.xml = {
        ...
        serialize: function() {
            for (var e = [], i = [], n = t.json.serialize(), a = 0, s = n.data.length; s > a; a++)
                e.push(this._copyObject(n.data[a]));
            for (var a = 0, s = n.links.length; s > a; a++)
                i.push(this._copyLink(n.links[a]));
    ...
    t._working_time_helper = {
        ...
        _timestamp: function(e) {
            var i = null ;
            return e.day || 0 === e.day ? i = e.day : e.date && (i = t.date.date_part(new Date(e.date)).valueOf()),
            i
        },
        set_time: function(t) {
            var e = void 0 !== t.hours ? t.hours : !0
              , i = this._timestamp(t);
            null  !== i ? this.dates[i] = e : this.hours = e,
        ...
        is_working_unit: function(e, i, n) {
            ...
            return -1 == a && (a = this._check_is_working_unit(e, i, n),
            this._working_units_cache.put(i, e, a)),
            a
        },
        _check_is_working_unit: function(t, e, i) {
            return void 0 === i && (i = this._get_unit_order(e)),
            void 0 === i ? !1 : i && !this.is_working_unit(t, this.units[i - 1], i - 1) ? !1 : this["is_work_" + e] ? this["is_work_" + e](t) : !0
        },
        ...
        get_working_hours: function(t) {
            var e = this._timestamp({
              ...
              , i = !0;
            return void 0 !== this.dates[e] ? i = this.dates[e] : void 0 !== this.dates[t.getDay()] && (i = this.dates[t.getDay()]),
            i === !0 ? this.hours : i ? i : []
        },
        intern_dates_pull: {},
        next_date: function(e, i, n) {
            ...
            return r || (r = this.intern_dates_pull[s] = {}),
            r[a] || (r[a] = t.date.add(e, n, i)),
            r[a]
        },
        get_work_units_between: function(t, e, i, n) {
            if (!i)
                return !1;
            for (var a = new Date(t), s = new Date(e), n = n || 1, r = 0; a.valueOf() < s.valueOf(); )
                this.is_working_unit(a, i) && r++,
        ...
        get_closest_worktime: function(e) {
            if (this.is_working_unit(e.date, e.unit))
                return e.date;
            var i = e.unit
            ...
            for ("past" == e.dir && (l = -1); !this.is_working_unit(n, i); ) {
                ...
                if (n = t.date.add(n, l, i),
                n = t._correct_dst_change(n, h, l, i),
                t.date[i + "_start"] && (n = t.date[i + "_start"](n)),
                d && (r ? a = n : s = n),
                r = !r,
                _++,
                _ > o)
                    return t.assert(!1, "Invalid working time check"),
                    !1
            }
            return (n == s || "past" == e.dir) && (n = t.date.add(n, 1, i)),
            n
        }
    },
    ...
    t.updateTask = function(e, i) {
        ...
        this.callEvent("onBeforeTaskUpdate", [e, i]) === !1 ? !1 : (this._pull[i.id] = i,
        this._is_parent_sync(i) || this._resync_parent(i),
        this._isAllowedUnscheduledTask(i) && (this._init_task(i),
        this._sync_links()),
        this._update_parents(i.id),
        this.refreshTask(i.id),
        this.callEvent("onAfterTaskUpdate", [e, i]),
        this._sync_order(),
    ...
    t.addTask = function(e, i, n) {
        return t.defined(i) || (i = this.getParent(e) || 0),
        this.isTaskExists(i) || (i = 0),
        this.setParent(e, i),
        e = this._init_task(e),
        this.callEvent("onBeforeTaskAdd", [e.id, e]) === !1 ? !1 : (this._pull[e.id] = e,
    ...
    t.createTask = function(e, i, n) {
        if (e = e || {},
        e.id = t.uid(),
        e.start_date || (e.start_date = t._default_task_date(e, i)),
        ...
        this._pull[e.id] = this._init_task(e),
        this._add_branch(e, n),
        e.$level = this.calculateTaskLevel(e),
        this.selectTask(e.id),
        this.refreshData(),
        this.showLightbox(e.id)) : this.addTask(e, i, n) && (this.showTask(e.id),
        this.selectTask(e.id)),
        e.id) : null 
    }
    ,
    ...
    t._getChildLinks = function(t) {
        ...
        if (!e)
            return [];
        for (var i = e.$source.concat(e.$target), n = this.getChildren(e.id), a = 0; a < n.length; a++)
            i = i.concat(this._getChildLinks(n[a]));
    ...
    t._getTaskTree = function(t) {
        ...
        if (!e)
            return [];
        for (var i = [], n = this.getChildren(e.id), a = 0; a < n.length; a++)
            i.push(n[a]),
    ...
    t._deleteRelatedLinks = function(t, e) {
        ...
        i && (n = this._dp.updateMode,
        this._dp.setUpdateMode("off"));
        for (var s = 0; s < t.length; s++)
            i && (this._dp.setGanttMode("links"),
    ...
    t._deleteRelatedTasks = function(t, e) {
        ...
        for (var a = this._getTaskTree(t), s = 0; s < a.length; s++) {
            var r = a[s];
            this._unset_task(r),
            i && this._dp.setUpdated(r, !0, "deleted")
        }
        i && this._dp.setUpdateMode(n)
    }
    ,
    ...
    t._init_task = function(e) {
        ...
        e.start_date ? !e.end_date && e.duration && (e.end_date = this.calculateEndDate(e.start_date, e.duration)) : e.end_date && void 0 !== e.duration && (e.start_date = this.calculateEndDate(e.end_date, -e.duration)),
    ...
    t._update_parents = function(e, i) {
        if (e) {
            ...
            if (n.$no_start || n.$no_end) {
                ...
                r == n.start_date.valueOf() && o == n.end_date.valueOf() && (s = !1),
    ...
    t.roundDate = function(e) {
        ...
        if (o == t._tasks.unit && r == t._tasks.step && +s >= +t._min_date && +s <= +t._max_date)
            a = Math.floor(t._day_index_by_date(s)),
            t._tasks.trace_x[a] || (a -= 1),
            n = new Date(t._tasks.trace_x[a]),
            i = new Date(n),
            i = t._tasks.trace_x[a + 1] ? new Date(t._tasks.trace_x[a + 1]) : t.date.add(n, r, o);
        else {
            for (a = Math.floor(t._day_index_by_date(s)),
            i = t.date[o + "_start"](new Date(this._min_date)),
    ...
    t._dp_init = function(e) {
        ...
        this._sendTaskOrder = function(t, i) {
            i.$drop_target && (e.setGanttMode("tasks"),
        ...
        e.attachEvent("onBeforeDataSending", function() {
            ...
            if ("REST" == this._tMode) {
                ...
                this.serverProcessor = e + t._urlSeparator(e) + "gantt_mode=" + this._ganttMode;
            return !0
        }),
        ...
        e._getRowData = t.bind(function(i, n) {
            ...
            return a.$no_start && (a.start_date = "",
            a.duration = ""),
            a.$no_end && (a.end_date = "",
            a.duration = ""),
    ...
    t._sync_links = function() {
        for (var t = null , e = 0, i = this._order_full.length; i > e; e++)
            t = this._pull[this._order_full[e]],
            t.$source = [],
            t.$target = [];
        this._links = [];
    ...
    t.updateLink = function(e, i) {
        ...
        this.callEvent("onBeforeLinkUpdate", [e, i]) === !1 ? !1 : (this._lpull[e] = i,
        this._sync_links(),
        this._render_link(e),
        this.callEvent("onAfterLinkUpdate", [e, i]),
        !0)
    }
    ,
    ...
    t._deleteLink = function(t, e) {
        ...
        this._sync_links(),
        this.refreshLink(t),
        e || this.callEvent("onAfterLinkDelete", [t, i]),
        !0) : !1
    }
    ,
    t.changeLinkId = function(t, e) {
        this._lpull[t] && (this._lpull[e] = this._lpull[t],
        this._lpull[e].id = e,
    ...
    t._configure = function(t, e, i) {
        for (var n in e)
            ("undefined" == typeof t[n] || i) && (t[n] = e[n])
    }
    ,
    ...
    t._get_skin = function(e) {
        ...
        r[1] && "undefined" == typeof r[1].width && (r[1].width = s._second_column_width),
        r[2] && "undefined" == typeof r[2].width && (r[2].width = s._third_column_width),
    ...
    t.getLightbox = function(e) {
        if (void 0 === e && (e = this.getLightboxType()),
        !this._lightbox || this.getLightboxType() != this._get_safe_type(e)) {
            this._lightbox_type = this._get_safe_type(e);
            var i = document.createElement("DIV");
            i.className = "gantt_cal_light";
            var n = this._is_lightbox_timepicker();
            (t.config.wide_form || n) && (i.className += " gantt_cal_light_wide"),
            n && (t.config.wide_form = !0,
            ...
            a += "</div>",
            i.innerHTML = a,
            t.config.drag_lightbox && (i.firstChild.onmousedown = t._ready_to_dnd,
    ...
    t._render_sections = function(t) {
        for (var e = "", i = 0; i < t.length; i++) {
            ...
            if (n) {
                ...
                e += "<div id='" + t[i].id + "' class='gantt_cal_lsection'>" + s + this.locale.labels["section_" + t[i].name] + "</div>" + n.render.call(this, t[i]),
                e += "</div>"
            }
        }
        return e
    ...
    t._init_lightbox_events = function() {
        ...
        t.lightbox_events["default"] = function(e, i) {
            if (i.getAttribute("dhx_button"))
                ...
                s = i.parentNode.parentNode) : (n = i.getAttribute("index"),
                s = i.parentNode,
                i = i.firstChild));
                var o = t._get_typed_lightbox_config();
                n && (a = t.form_blocks[o[n].type],
        ...
        this.event(t.getLightbox(), "click", function(e) {
            ...
            var i = e.target ? e.target : e.srcElement
              , n = t._getClassName(i);
            if (n || (i = i.previousSibling,
            n = t._getClassName(i)),
            i && n && 0 === n.indexOf("gantt_btn_set") && (i = i.firstChild,
            n = t._getClassName(i)),
            i && n) {
    ...
    t._save_lightbox = function() {
        ...
        this.addTask(t)) : this.isTaskExists(t.id) && (this.mixin(this.getTask(t.id), t, !0),
    ...
    t._set_lightbox_values = function(e, i) {
        ...
        t.templates.lightbox_header ? (a[1].innerHTML = "",
        a[2].innerHTML = t.templates.lightbox_header(n.start_date, n.end_date, n)) : (a[1].innerHTML = this.templates.task_time(n.start_date, n.end_date, n),
        a[2].innerHTML = (this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70));
        for (var s = this._get_typed_lightbox_config(this.getLightboxType()), r = 0; r < s.length; r++) {
            ...
            if (this.form_blocks[o.type]) {
                ...
                d.set_value.call(t, _, h, n, o),
                o.focus && d.focus.call(t, _)
            }
        }
    ...
    t.form_blocks = {
        getTimePicker: function(e, i) {
            ...
            var a = this.config
              ...
              , r = 1440
              , o = 0;
            t.config.limit_time_select && (r = 60 * a.last_hour + 1,
            o = 60 * a.first_hour,
            ...
            for (var _ = "", d = 0; d < n.length; d++) {
                ...
                case "%Y":
                    ...
                    f = e.year_range[1]) : c = e.year_range),
                    c = c || 10,
                    u = u || Math.floor(c / 2),
                    g = g || s.getFullYear() - u,
                    f = f || g + c;
                ...
                case "%m":
                    ...
                    e._time_format_order.size++;
                    for (var p = 0; 12 > p; p++)
                        h += "<option value='" + p + "'>" + this.locale.date.month_full[p] + "</option>";
                    break;
                case "%d":
                ...
                case "%H:%i":
                    ...
                    for (e._time_values = []; r > p; ) {
                        ...
                        h += "<option value='" + p + "'>" + m + "</option>",
                        e._time_values.push(p),
                        s.setTime(s.valueOf() + 60 * this._get_timepicker_step() * 1e3);
        ...
        _fill_lightbox_select: function(e, i, n, a, s) {
            if (e[i + a[0]].value = n.getDate(),
            e[i + a[1]].value = n.getMonth(),
            e[i + a[2]].value = n.getFullYear(),
            t.defined(a[3])) {
        ...
        time: {
            ...
            set_value: function(e, i, n, a) {
                ...
                if (s.auto_end_date)
                    for (var _ = function() {
                        h = new Date(r[o[2]].value,r[o[1]].value,r[o[0]].value,0,0),
                        c = t.calculateEndDate(h, 1),
                ...
                this.form_blocks._fill_lightbox_select(r, 0, h, o, s),
                this.form_blocks._fill_lightbox_select(r, o.size, c, o, s)
            },
        ...
        parent: {
            _filter: function(e, i, n) {
                ...
                for (var s = 0; s < e.length; s++) {
                    var r = e[s];
                    (r.id == n || t.isChildOf(r.id, n) || a(r.id, r) === !1) && (e.splice(s, 1),
                    s--)
                }
                return e
            },
            ...
            set_value: function(e, i, n, a) {
                ...
                t.form_blocks.select.set_value.apply(t, [r, i, n, a])
            },
            get_value: function() {
        ...
        var i = e
          , n = {
            ...
            update_block: function(e, i) {
                if (t.callEvent("onSectionToggle", [t._lightbox_id, i]),
    ...
    t.dataProcessor.prototype = {
        ...
        markRow: function(t, e, i) {
            ...
            a && a.details)) {
                ...
                for (var s = 0; s < a.details.length; s++)
                    a.details[s] && this.obj[this._methods[1]](t, s, n)
            }
        },
        getState: function(t) {
        ...
        serialize: function(e, i) {
            ...
            var n = []
              , a = [];
            for (var s in e)
                e.hasOwnProperty(s) && (n.push(this.serialize_one(e[s], s + this.post_delim)),
                a.push(s));
            ...
            for (var n in t)
                if (t.hasOwnProperty(n)) {
                    if (("id" == n || n == this.action_param) && "REST" == this._tMode)
                        continue;i.push(this.escape((e || "") + n) + "=" + this.escape(t[n]));
                }
            return i.join("&")
        },
        _sendData: function(e, i) {
            if (e) {
                ...
                if ("GET" == this._tMode)
                    t.ajax.get(s + (-1 != s.indexOf("?") ? "&" : "?") + this.serialize(e, i), a);
                else if ("POST" == this._tMode)
                    t.ajax.post(s, this.serialize(e, i), a);
                else if ("REST" == this._tMode) {
                    var r = this.getState(i)
                      , o = s.replace(/(\&|\?)editing\=true/, "")
                      , _ = ""
                      , d = "post";
                    if ("inserted" == r ? _ = this.serialize(e, i) : "deleted" == r ? (d = "DELETE",
                    o = o + ("/" == o.slice(-1) ? "" : "/") + i) : (d = "PUT",
                    _ = this.serialize(e, i),
                    o = o + ("/" == o.slice(-1) ? "" : "/") + i),
                    this._payload)
                        for (var l in this._payload)
                            o = o + this._urlSeparator(o) + this.escape(l) + "=" + this.escape(this._payload[l]);
                    t.ajax.query({
                        url: o,
                        method: d,
                    ...
                    for (var e = 0; e < this.updatedRows.length; e++)
                        if (!this._in_progress[this.updatedRows[e]]) {
                            if (this.is_invalid(this.updatedRows[e]))
                                continue;if (this._beforeSendData(this._getRowData(this.updatedRows[e]), this.updatedRows[e]),
    ...
    t._insert_callback = function(e, i, n, a) {
        ...
        "links" == a && (r.add = t.addLink,
        r.isExist = t.isLinkExists),
        r.isExist.call(t, i) || (s.id = i,
        r.add.call(t, s))
    }
    ,
    t._delete_callback = function(e, i, n, a) {
        ...
        "links" == a && (s["delete"] = t.deleteLink,
        s.isExist = t.isLinkExists),
        s.isExist.call(t, i) && s["delete"].call(t, i)
    }
    ,
    t._get_safe_type = function(e) {
        for (var i in this.config.types)
            if (this.config.types[i] == e)
                return e;
                ...
                if (i) {
                    ...
                    e[t] = function() {
                        if (n.active) {
                            ...
                            n.cache[t] || (n.cache[t] = {});
                            var a = n.cache[t];
                            if (n.has_cached_value(a, e))
                                return n.get_cached_value(a, e);
                            var s = i.apply(this, arguments);
                            return n.cache_value(a, e, s),
                            s
                        }
    ...
    t._init_html_area = function(e) {
        ...
        i += "<div class='gantt_ver_scroll'><div></div></div><div class='gantt_hor_scroll'><div></div></div></div>",
        this._obj.innerHTML = i,
        ...
        buttons: {
            ...
            "delete": function(e) {
                ...
                t._dhtmlx_confirm(i, n, function() {
                    ...
                    var i = t.getTask(e);
                    i.$new ? (t._deleteTask(e, !0),
                    t.refreshData()) : t.deleteTask(e),
                    t.hideLightbox()
                })
            }
        }
    ...
    t._get_box_styles = function() {
        ...
        for (var n = 0; n < e.length; n++)
            i[e[n]] = t[e[n]] ? this._clean_el_size(t[e[n]]) : 0;
        var a = {
    ...
    t._restore_scroll_state = function() {
        ...
        return this._cached_scroll_pos && (t.x = this._cached_scroll_pos.x || t.x,
    ...
    t.scrollTo = function(e, i) {
        ...
        1 * e == e && (this.$task.scrollLeft = e,
        this._save_scroll_state(e, void 0)),
        1 * i == i && (this.$task_data.scrollTop = i,
        this.$grid_data.scrollTop = i,
        t.config.smart_rendering && this.$grid_data.scrollTop != i && (this.$grid_data.scrollTop = i % t.config.row_height),
        this._save_scroll_state(void 0, this.$task_data.scrollTop));
    ...
    t.render = function() {
        if (this._is_render_active()) {
            ...
            var e = this.copy(this._restore_scroll_state())
              , i = null ;
            if (e && (i = t.dateFromPos(e.x + this.config.task_scroll_offset)),
            this._render_grid(),
            this._render_tasks_scales(),
            this._scroll_resize(),
            this._on_resize(),
            this._render_data(),
            this.config.preserve_scroll && e) {
    ...
    t._set_scroll_events = function() {
        function e(e) {
            ...
            if (a && Math.abs(a) > Math.abs(s)) {
                if (n.x)
                    return !0;
                if (!t.$scroll_hor || !t.$scroll_hor.offsetWidth)
                    return !0;
                var r = a / -40
                  , o = t.$task.scrollLeft
                  , _ = o + 30 * r;
                if (t.scrollTo(_, null ),
                t.$scroll_hor.scrollLeft = _,
                o == t.$task.scrollLeft)
                    return !0
            } else {
                if (n.y)
                    return !0;
                if (!t.$scroll_ver || !t.$scroll_ver.offsetHeight)
                    return !0;
                var r = s / -40;
                "undefined" == typeof s && (r = e.detail);
                var d = t.$scroll_ver.scrollTop
                  , l = t.$scroll_ver.scrollTop + 30 * r;
                if (!t.config.prevent_default_scroll && t._cached_scroll_pos && (t._cached_scroll_pos.y == l || t._cached_scroll_pos.y <= 0 && 0 >= l))
                    return !0;
                if (t.scrollTo(null , l),
                t.$scroll_ver.scrollTop = l,
                d == t.$scroll_ver.scrollTop)
                    return !0
            }
        ...
        this.event(this.$scroll_hor, "scroll", function() {
            if (new Date - (t._wheel_time || 0) < 100)
                return !0;
    ...
    t._scroll_resize = function() {
        if (!(this._x < 20 || this._y < 20)) {
            ...
            t.x ? (this.$scroll_hor.style.display = "block",
            this.$scroll_hor.style.height = t.scroll_size + "px",
            this.$scroll_hor.style.width = t.x + "px",
            this.$scroll_hor.firstChild.style.width = t.x_inner + "px") : (this.$scroll_hor.style.display = "none",
            this.$scroll_hor.style.height = this.$scroll_hor.style.width = "0px"),
            t.y ? (this.$scroll_ver.style.display = "block",
            ...
            this.$scroll_ver.firstChild.style.height = t.y_inner + "px") : (this.$scroll_ver.style.display = "none",
    ...
    t._scroll_sizes = function() {
        ...
        return o && (d.x = Math.max(this._x - (_ ? n : 2), 0)),
        _ && (d.y = Math.max(this._y - (o ? n : 0) - this.config.scale_height, 0)),
        d
    }
    ,
    ...
    t.batchUpdate = function(t, e) {
        ...
        this._sync_links = s,
        this._sync_links(),
        this.resetProjectDates = _;
        for (var l in o)
            this.resetProjectDates(o[l]);
        this._adjust_scales = r,
        this._adjust_scales(),
        this._skip_render = !1,
        e || this.render(),
    ...
    t.ajax = {
        ...
        parse: function(e) {
            ...
            window.DOMParser && !t.env.isIE ? i = (new window.DOMParser).parseFromString(e, "text/xml") : window.ActiveXObject !== window.undefined && (i = new window.ActiveXObject("Microsoft.XMLDOM"),
            i.async = "false",
            i.loadXML(e)),
            i
        },
        xmltop: function(e, i, n) {
            if ("undefined" == typeof i.status || i.status < 400) {
                ...
                if (a && null  !== a.documentElement && !a.getElementsByTagName("parsererror").length)
        ...
        xpath: function(e, i) {
            if (i.nodeName || (i = i.responseXML || i),
            t.env.isIE)
                return i.selectNodes(e) || [];
        ...
        _call: function(e, i, n, a, s, r, o) {
            ...
            if (a && (_.onreadystatechange = function() {
                if (4 == _.readyState || d && 3 == _.readyState) {
                    if ((200 != _.status || "" === _.responseText) && !t.callEvent("onAjaxError", [_]))
                        return;
                    window.setTimeout(function() {
            ...
            o)
                for (var l in o)
                    _.setRequestHeader(l, o[l]);
            else
                "POST" == e.toUpperCase() || "PUT" == e || "DELETE" == e ? _.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == e && (n = null );
    ...
    function() {
        ...
        function i(i) {
            if (u) {
                ...
                return t.message.keyboard && ((13 == n || 32 == n) && e(u, !0),
                27 == n && e(u, !1)),
        ...
        function s(t) {
            ...
            g.area.className = "gantt_message_area dhtmlx_message_area",
            g.area.style[g.position] = "5px",
            document.body.appendChild(g.area)),
            g.hide(t.id);
            var e = document.createElement("DIV");
            return e.innerHTML = "<div>" + t.text + "</div>",
            e.className = "gantt-info dhtmlx-info gantt-" + t.type + " dhtmlx-" + t.type,
            e.onclick = function() {
                g.hide(t.id),
                t = null 
            }
            ,
            "bottom" == g.position && g.area.firstChild ? g.area.insertBefore(e, g.area.firstChild) : g.area.appendChild(e),
            t.expire > 0 && (g.timers[t.id] = window.setTimeout(function() {
                g.hide(t.id)
            }, t.expire)),
            g.pull[t.id] = e,
            e = null ,
        ...
        function r(t, i, n) {
            var s = document.createElement("DIV");
            s.className = " gantt_modal_box dhtmlx_modal_box gantt-" + t.type + " dhtmlx-" + t.type,
            s.setAttribute("dhxbox", 1);
            var r = "";
            if (t.width && (s.style.width = t.width),
            t.height && (s.style.height = t.height),
            t.title && (r += '<div class="gantt_popup_title dhtmlx_popup_title">' + t.title + "</div>"),
            r += '<div class="gantt_popup_text dhtmlx_popup_text"><span>' + (t.content ? "" : t.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">',
            i && (r += a(t.ok || "OK", !0)),
            n && (r += a(t.cancel || "Cancel", !1)),
            t.buttons)
            ...
            t.content) {
                var _ = t.content;
                "string" == typeof _ && (_ = document.getElementById(_)),
                "none" == _.style.display && (_.style.display = ""),
                s.childNodes[t.title ? 1 : 0].appendChild(_)
            }
        ...
        function o(e, a, s) {
            ...
            return "top" == e.position ? o.style.top = "-3px" : o.style.top = d + "px",
            o.style.left = _ + "px",
            o.onkeydown = i,
            o.focus(),
            e.hidden && t.modalbox.hide(o),
            o
        }
        function _(t) {
            return o(t, !0, !1)
        ...
        g.hide = function(t) {
            ...
            e.className += " hidden",
            g.timers[t] && window.clearTimeout(g.timers[t]),
            delete g.pull[t])
        }
    }(),
    t.date = {
        init: function() {
            for (var e = t.locale.date.month_short, i = t.locale.date.month_short_hash = {}, n = 0; n < e.length; n++)
                i[e[n]] = n;
            for (var e = t.locale.date.month_full, i = t.locale.date.month_full_hash = {}, n = 0; n < e.length; n++)
                i[e[n]] = n;
        },
    ...
    function() {
        ...
        t._init_template = function(t, e, i) {
            ...
            i = i || t,
            this.config[t] && n[i] != this.config[t] && (e && this.templates[i] || (this.templates[i] = this.date.date_to_str(this.config[t]),
            n[i] = this.config[t])),
        ...
        t._init_templates = function() {
            ...
            t.mixin(this.templates, {
                ...
                drag_link: function(e, i, n, a) {
                    ...
                    return n && (n = t.getTask(n),
                    r += "<b> " + n.text + "</b> " + (a ? s.link_start : s.link_end) + "<br/>"),
                    r
                },
    ...
    t._touch_events = function(e, i, n) {
        ...
        function s(e) {
            ...
            if (n && t.isTaskVisible(e))
                for (var a in i)
                    if (n = i[a][e],
                    n && n.getAttribute("task_id") && n.getAttribute("task_id") == e) {
                        var s = n.cloneNode(!0);
                        return c = n,
                        i[a][e] = s,
                        n.style.display = "none",
                        s.className += " gantt_drag_move ",
        ...
        t.event(t.$container, e[0], function(e) {
            if (!n(e) && _) {
                h && clearTimeout(h);
                var s = i(e);
                if (t._tasks_dnd.drag.id || t._tasks_dnd.drag.start_drag)
                    return t._tasks_dnd.on_mouse_move(s),
                ...
                if (s && l) {
                    var c = l.pageX - s.pageX
                      , u = l.pageY - s.pageY;
                    if (!d && (Math.abs(c) > 5 || Math.abs(u) > 5) && (t._touch_scroll_active = d = !0,
                    o = 0,
                    r = t.getScrollState()),
                    d) {
                        t.scrollTo(r.x + c, r.y + u);
                        var g = t.getScrollState();
                        if (r.x != g.x && u > 2 * c || r.y != g.y && c > 2 * u)
                            return a(e)
                    }
                }
                return a(e)
        ...
        t.event(this.$container, e[1], function(e) {
            if (!n(e)) {
                ...
                l && o) {
                    var r = new Date;
                    500 > r - o ? (t._on_dblclick(l),
                    a(e)) : o = r
                } else
                    o = new Date;
                h = setTimeout(function() {
                    var e = t.locate(l);
                    !e || t._locate_css(l, "gantt_link_control") || t._locate_css(l, "gantt_grid_data") || (t._tasks_dnd.on_mouse_down(l),
                    t._tasks_dnd.drag && t._tasks_dnd.drag.start_drag && (s(e),
                    t._tasks_dnd._start_dnd(l),
                    t._touch_drag = !0,
                    t.refreshTask(e),
                    t._touch_feedback())),
                    h = null 
        ...
        t.event(this.$container, e[2], function(e) {
            if (!n(e)) {
                ...
                _ = !1;
                var a = i(e);
                t._tasks_dnd.on_mouse_up(a),
                c && (t.refreshTask(t.locate(c)),
                c.parentNode && (c.parentNode.removeChild(c),
                t._touch_feedback())),
                t._touch_scroll_active = _ = d = !1,
                c = null 
            }
        })
    }
    ...
    function() {
        ...
        for (var n = ["message", "alert", "confirm", "modalbox", "uid", "copy", "mixin", "defined", "bind", "assert"], a = 0; a < n.length; a++)
            window.dhtmlx[n[a]] || (dhtmlx[n[a]] = i(n[a]));
    ...
    for (var e = 0; e < Gantt._ganttPlugin.length; e++)
        Gantt._ganttPlugin[e](t);
