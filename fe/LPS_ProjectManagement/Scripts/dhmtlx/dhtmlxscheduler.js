...
function dtmlXMLLoaderObject(e, t, i, s) {
    return this.xmlDoc = "",
    "undefined" != typeof i ? this.async = i : this.async = !0,
...
dhtmlx.extend_api = function(e, t, i) {
    ...
    ,
    window[e].prototype = s.prototype,
...
dhtmlxAjax = {
    ...
    post: function(e, t, i) {
        ...
        return s.async = arguments.length < 4,
        s.waitCall = i,
        s.loadXML(e, !0, t),
        s
    },
...
dtmlXMLLoaderObject.prototype.getXMLTopNode = function(e, t) {
    ...
    if (this.xmlDoc.responseXML) {
        ...
        if (0 === s.length && -1 != e.indexOf(":"))
            var s = this.xmlDoc.responseXML.getElementsByTagName(e.split(":")[1]);
        i = s[0]
    } else
...
dtmlXMLLoaderObject.prototype.loadXML = function(e, t, i, s) {
    ...
    s ? (this.xmlDoc.setRequestHeader("User-Agent", "dhtmlxRPC v0.1 (" + navigator.userAgent + ")"),
...
dtmlXMLLoaderObject.prototype.xmlNodeToJSON = function(e) {
    ...
    for (var i = 0; i < e.childNodes.length; i++) {
        ...
        s && (t[s] || (t[s] = []),
        t[s].push(this.xmlNodeToJSON(e.childNodes[i])))
    }
    return t
}
,
...
dhtmlDragAndDropObject.prototype.preCreateDragCopy = function(e) {
    return !e && !window.event || 2 != (e || event).button ? window.dhtmlDragAndDrop.waitDrag ? (window.dhtmlDragAndDrop.waitDrag = 0,
...
dhtmlDragAndDropObject.prototype.callDrag = function(e) {
    ...
    if (!((new Date).valueOf() - t.downtime < 100)) {
        ...
        if (t.dragNode.parentNode != window.document.body && t.gldragNode) {
            var i = t.gldragNode;
            t.gldragNode.old && (i = t.gldragNode.old),
            ...
            document.body.appendChild(t.dragNode),
            s.dhtmlDragAndDrop.dragNode = t.dragNode
        }
        ...
        var n;
        n = e.srcElement ? e.srcElement : e.target,
        t.checkLanding(n, e)
    }
}
,
dhtmlDragAndDropObject.prototype.calculateFramePosition = function(e) {
    if (window.name) {
        for (var t = parent.frames[window.name].frameElement.offsetParent, i = 0, s = 0; t; )
            i += t.offsetLeft,
            s += t.offsetTop,
            t = t.offsetParent;
...
dhtmlDragAndDropObject.prototype.stopDrag = function(e, t) {
    ...
    if (!t) {
        ...
        var s = i.lastLanding;
        i.lastLanding = null ,
        s && s.dragLanding._drag(i.dragStartNode, i.dragStartObject, s, _isIE ? event.srcElement : e.target);
    }
    i.lastLanding = null ,
...
dtmlXMLLoaderObject.prototype.doXPath = function(e, t, i, s) {
    ...
    if (_isIE)
        ...
        "single" == s ? t.selectSingleNode(e) : t.selectNodes(e) || new Array(0);
    var a = t;
...
dtmlXMLLoaderObject.prototype.doXPathOpera = function(e, t) {
    ...
    if ("." == i[0])
        ...
        if ("" !== i[0])
            return [];
        s = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(i[a].replace(/\[[^\]]*\]/g, "")),
        a++
    }
    for (a; a < i.length; a++)
        s = this._getAllNamedChilds(s, i[a]);
    return -1 != i[a - 1].indexOf("[") && (s = this._filterXPath(s, i[a - 1])),
    s
}
,
dtmlXMLLoaderObject.prototype._filterXPath = function(e, t) {
    for (var i = [], t = t.replace(/[^\[]*\[\@/g, "").replace(/[\[\]\@]*/g, ""), s = 0; s < e.length; s++)
        e[s].getAttribute(t) && (i[i.length] = e[s]);
    return i
}
,
dtmlXMLLoaderObject.prototype._getAllNamedChilds = function(e, t) {
    ...
    for (var s = 0; s < e.length; s++)
        for (var a = 0; a < e[s].childNodes.length; a++)
            _isKHTML ? e[s].childNodes[a].tagName && e[s].childNodes[a].tagName.toUpperCase() == t && (i[i.length] = e[s].childNodes[a]) : e[s].childNodes[a].tagName == t && (i[i.length] = e[s].childNodes[a]);
    return i
}
,
...
dtmlXMLLoaderObject.prototype.doXSLTransToObject = function(e, t) {
    ...
    if (_isIE) {
        ...
        i = this.XSLProcessor.transformToDocument(t);
    return i
}
,
...
dhtmlxEventable = function(obj) {
    obj.attachEvent = function(e, t, i) {
        return e = "ev_" + e.toLowerCase(),
        this[e] || (this[e] = new this.eventCatcher(i || this)),
        e + ":" + this[e].addEvent(t)
    }
    ,
    obj.callEvent = function(e, t) {
        return e = "ev_" + e.toLowerCase(),
        this[e] ? this[e].apply(this, t) : !0
    }
    ,
...
function() {
    ...
    function t(t) {
        if (c) {
            ...
            return dhtmlx.message.keyboard && ((13 == i || 32 == i) && e(c, !0),
            27 == i && e(c, !1)),
    ...
    function n(t, i, a) {
        ...
        n.className = " dhtmlx_modal_box dhtmlx-" + t.type,
        n.setAttribute("dhxbox", 1);
        var r = "";
        if (t.width && (n.style.width = t.width),
        t.height && (n.style.height = t.height),
        t.title && (r += '<div class="dhtmlx_popup_title">' + t.title + "</div>"),
        r += '<div class="dhtmlx_popup_text"><span>' + (t.content ? "" : t.text) + '</span></div><div  class="dhtmlx_popup_controls">',
        i) {
        ...
        t.content) {
            ...
            "none" == h.style.display && (h.style.display = ""),
            n.childNodes[t.title ? 1 : 0].appendChild(h)
        }
        return n.onclick = function(i) {
            i = i || event;
            var s = i.target || i.srcElement;
            if (s.className || (s = s.parentNode),
            "dhtmlx_popup_button" == s.className.split(" ")[0]) {
    ...
    function r(e, s, a) {
        ...
        r.onkeydown = t,
        r.focus(),
        e.hidden && dhtmlx.modalbox.hide(r),
        r
    }
    function d(e) {
        return r(e, !0, !1)
    ...
    function h(e, t, i) {
        return "object" != typeof e && ("function" == typeof t && (i = t,
        t = ""),
        e = {
            text: e,
            type: t,
...
dataProcessor.prototype = {
    ...
    setUpdated: function(e, t, i) {
        if (!this._silent_mode) {
            ...
            this.updatedRows[s] = e,
            this.obj.setUserData(e, this.action_param, i),
            this._in_progress[e] && (this._in_progress[e] = "wait")) : this.is_invalid(e) || (this.updatedRows.splice(s, 1),
    ...
    markRow: function(e, t, i) {
        var s = ""
          , a = this.is_invalid(e);
        if (a && (s = this.styles[a],
        t = !0),
        this.callEvent("onRowMark", [e, t, i, a]) && (s = this.styles[t ? i : "clear"] + s,
        this.obj[this._methods[0]](e, s),
        a && a.details)) {
            s += this.styles[a + "_cell"];
            for (var n = 0; n < a.details.length; n++)
                a.details[n] && this.obj[this._methods[1]](e, n, s)
        }
    },
    getState: function(e) {
    ...
    sendData: function(e) {
        ...
        "undefined" == typeof e || this._tSend ? this.sendAllData() : this._in_progress[e] ? !1 : (this.messages = [],
        !this.checkBeforeUpdate(e) && this.callEvent("onValidationError", [e, this.messages]) ? !1 : void this._beforeSendData(this._getRowData(e), e))) : void 0;
    },
    ...
    serialize: function(e, t) {
        ...
        var i = []
          , s = [];
        for (var a in e)
            e.hasOwnProperty(a) && (i.push(this.serialize_one(e[a], a + this.post_delim)),
            s.push(a));
        return i.push("ids=" + this.escape(s.join(","))),
        dhtmlx.security_key && i.push("dhx_security=" + dhtmlx.security_key),
        i.join("&")
    },
    serialize_one: function(e, t) {
        ...
        for (var s in e)
            if (e.hasOwnProperty(s)) {
                if (("id" == s || s == this.action_param) && "REST" == this._tMode)
                    continue;i.push(this.escape((t || "") + s) + "=" + this.escape(e[s]))
            }
        return i.join("&")
    },
    _sendData: function(e, t) {
        if (e) {
            ...
            if ("GET" == this._tMode)
                i.loadXML(s + (-1 != s.indexOf("?") ? "&" : "?") + this.serialize(e, t));
            else if ("POST" == this._tMode)
                i.loadXML(s, !0, this.serialize(e, t));
                ...
                for (var t = 0; t < this.updatedRows.length; t++)
                    if (!this._in_progress[this.updatedRows[t]]) {
                        if (this.is_invalid(this.updatedRows[t]))
                            continue;if (this._beforeSendData(this._getRowData(this.updatedRows[t]), this.updatedRows[t]),
    ...
    _getAllData: function(e) {
        for (var t = {}, i = !1, s = 0; s < this.updatedRows.length; s++) {
            ...
            this._in_progress[a] || this.is_invalid(a) || this.callEvent("onBeforeUpdate", [a, this.getState(a), this._getRowData(a)]) && (t[a] = this._getRowData(a, a + this.post_delim),
            i = !0,
    ...
    afterUpdateCallback: function(e, t, i, s) {
        var a = e
          , n = "error" != i && "invalid" != i;
        if (n || this.set_invalid(e, i),
        this._uActions && this._uActions[i] && !this._uActions[i](s))
        ...
        case "inserted":
        case "insert":
            t != e && (this.obj[this._methods[2]](e, t),
            e = t);
            break;
        case "delete":
        case "deleted":
            ...
            this.callEvent("onAfterUpdate", [e, i, t, s])
        }
        "wait" != this._in_progress[a] ? (n && this.obj.setUserData(e, this.action_param, ""),
        delete this._in_progress[a]) : (delete this._in_progress[a],
        this.setUpdated(t, !0, this.obj.getUserData(e, this.action_param))),
        this.callEvent("onAfterUpdate", [r, i, t, s])
    },
        ...
        if (window.JSON)
            try {
                var s = JSON.parse(t.xmlDoc.responseText)
                  ...
                  , n = s.sid || i[0]
                  , r = s.tid || i[0];
                return e.afterUpdateCallback(n, r, a, s),
                void e.finalizeUpdate()
            } catch (d) {}
        if (t.getXMLTopNode("data"),
        !t.xmlDoc.responseXML)
            return this.obj && this.obj.callEvent && this.obj.callEvent("onSaveError", [i, t.xmlDoc]),
            this.cleanUpdate(i);
    ...
    setAutoUpdate: function(e, t) {
        ...
        this._loader = null ,
        this._update_busy = !1,
        this.attachEvent("onAfterUpdate", function(e, t, i, s) {
    ...
    getUpdates: function(e, t) {
        ...
        this._loader.waitCall = t,
        void this._loader.loadXML(e))
    },
    _v: function(e) {
            ...
            if (s.length) {
                ...
                for (var a = 0; a < s.length; a++) {
                    var n = s[a].getAttribute("status")
                      , r = s[a].getAttribute("id")
                      , d = s[a].getAttribute("parent");
                    switch (n) {
                    case "inserted":
                        e.callEvent("insertCallback", [s[a], r, d]);
                        break;
                    case "updated":
                        e.callEvent("updateCallback", [s[a], r, d]);
                        break;
                    case "deleted":
                        e.callEvent("deleteCallback", [s[a], r, d])
                    }
                }
                e._silent_mode = !1
            }
...
Scheduler.getSchedulerInstance = function() {
    ...
    scheduler.set_xy = function(e, t, i, s, a) {
        ...
        e.style.height = Math.max(0, i) + "px",
        arguments.length > 3 && (e.style.left = s + "px",
        e.style.top = a + "px")
    }
    ,
    ...
    scheduler.select = function(e) {
        this._select_id != e && (scheduler._close_not_saved(),
        this.editStop(!1),
        this.unselect(),
        this._select_id = e,
        this.updateEvent(e))
    ...
    scheduler._click = {
        dhx_cal_data: function(e) {
            ...
            if (i && scheduler.config.select) {
                ...
                (new Date).valueOf() - (scheduler._new_event || 0) > 500 && scheduler.unselect();
        },
    ...
    scheduler.addEventNow = function(e, t, i) {
        var s = {};
        e && null !== e.constructor.toString().match(/object/i) && (s = e,
        e = null );
        ...
        if (!t) {
            ...
            r > n.getHours() && (n.setHours(r),
            e = n.valueOf()),
            t = e.valueOf() + a
        }
        var d = new Date(t);
        n.valueOf() == d.valueOf() && d.setTime(d.valueOf() + a),
        s.start_date = s.start_date || n,
        s.end_date = s.end_date || d,
        s.text = s.text || this.locale.labels.new_event,
        s.id = this._drag_id = s.id || this.uid(),
    ...
    scheduler._on_dbl_click = function(e, t) {
        ...
        !this.config.readonly) {
            ...
            case "dhx_cal_event_clear":
                ...
                if (!this.callEvent("onDblClick", [s, e]))
                    return;
    ...
    scheduler._get_column_index = function(e) {
        var t = 0;
        if (this._cols) {
            for (var i = 0, s = 0; s < this._cols.length && !i; s++)
                i = this._cols[s];
            if (t = i ? e / i : 0,
            this._ignores)
                for (var s = 0; t >= s; s++)
    ...
    scheduler._mouse_coords = function(e) {
        ...
        t.x -= getAbsoluteLeft(this._obj) + (this._table_view ? 0 : this.xy.scale_width),
        t.y -= getAbsoluteTop(this._obj) + this.xy.nav_height + (this._dy_shift || 0) + this.xy.scale_height - this._els.dhx_cal_data[0].scrollTop,
        t.ev = e;
        ...
        if (a)
            ...
            (scheduler._drag_mode || "month" == this._mode) && (t.y = 24 * (Math.max(0, Math.ceil(n) - 1) + 7 * Math.max(0, r - 1)) * 60 / this.config.time_step),
            "move" == this._drag_mode && scheduler._ignores_detected && scheduler.config.preserve_length && (t._ignores = !0,
    ...
    scheduler._is_pos_changed = function(e, t) {
        ...
        var s = 100
          , a = 5;
        return !!(this._drag_pos.has_moved || !this._drag_pos.timestamp || t.timestamp - this._drag_pos.timestamp > s || i(e.ev.clientX, t.ev.clientX, a) || i(e.ev.clientY, t.ev.clientY, a))
    }
    ,
    scheduler._correct_drag_start_date = function(e) {
        var t;
        scheduler.matrix && (t = scheduler.matrix[scheduler._mode]),
        t = t || {
            x_step: 1,
            x_unit: "day"
        },
    ...
    scheduler._correct_drag_end_date = function(e, t) {
        var i;
        scheduler.matrix && (i = scheduler.matrix[scheduler._mode]),
        i = i || {
            x_step: 1,
            x_unit: "day"
        };
        ...
        if (this._drag_mode) {
            ...
            if (this._is_pos_changed(this._drag_pos, t)) {
                ...
                "create" == this._drag_mode) {
                    ...
                    this._loading = !0,
                    i = this._get_date_from_pos(t).valueOf(),
                    !this._drag_start) {
                        var a = this.callEvent("onBeforeEventCreated", [e, this._drag_id]);
                        return a ? (this._loading = !1,
                    ...
                    this.addEvent(n, r, this.locale.labels.new_event, this._drag_id, t.fields),
                    this.callEvent("onEventCreated", [this._drag_id, e]),
                    this._loading = !1,
                    this._drag_mode = "new-size"
                }
                var d, o = this.getEvent(this._drag_id);
                if (scheduler.matrix && (d = scheduler.matrix[scheduler._mode]),
                d = d || {
                    x_step: 1,
                    x_unit: "day"
                },
                "move" == this._drag_mode)
                    i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)),
                    !t.custom && this._table_view && (i += 1e3 * this.date.time_part(o.start_date)),
                    i = this._correct_shift(i),
                    t._ignores && this.config.preserve_length && this._table_view ? (i = scheduler._correct_drag_start_date(i),
                    s = scheduler._correct_drag_end_date(i, this._drag_event._event_length)) : s = o.end_date.valueOf() - (o.start_date.valueOf() - i);
                else {
                    if (i = o.start_date.valueOf(),
                    s = o.end_date.valueOf(),
                    this._table_view) {
                        var l = this._min_date.valueOf() + t.y * this.config.time_step * 6e4 + (t.custom ? 0 : 864e5);
                        if ("month" == this._mode)
                            if (l = this._correct_shift(l, !1),
                            ...
                            t.resize_from_start ? i = scheduler._correct_drag_start_date(l) : s = scheduler._correct_drag_end_date(l, 0)
                    } else {
                        var _ = this.date.date_part(new Date(o.end_date.valueOf() - 1)).valueOf()
                          , c = new Date(_);
                        s = _ + t.y * this.config.time_step * 6e4,
                        s += 6e4 * (new Date(s).getTimezoneOffset() - c.getTimezoneOffset()),
                        this._els.dhx_cal_data[0].style.cursor = "s-resize",
                        ("week" == this._mode || "day" == this._mode) && (s = this._correct_shift(s))
                    }
                    if ("new-size" == this._drag_mode)
                        if (s <= this._drag_start) {
                            var u = t.shift || (this._table_view && !t.custom ? 864e5 : 0);
                            i = s - (t.shift ? 0 : u),
                            s = this._drag_start + (u || 6e4 * this.config.time_step)
                        } else
                            i = this._drag_start;
                    else
                        i >= s && (s = i + 6e4 * this.config.time_step)
                }
                var g = new Date(s - 1)
                  , f = new Date(i);
                if ("move" == this._drag_mode && scheduler.config.limit_drag_out && (+f < +scheduler._min_date || +s > +scheduler._max_date)) {
                    if (+o.start_date < +scheduler._min_date || +o.end_date > +scheduler._max_date)
                        f = new Date(o.start_date),
                        s = new Date(o.end_date);
                    else {
                        var v = s - f;
                        +f < +scheduler._min_date ? (f = new Date(scheduler._min_date),
                        t._ignores && this.config.preserve_length && this._table_view ? (f = new Date(scheduler._correct_drag_start_date(f)),
                        d._start_correction && (f = new Date(f.valueOf() + d._start_correction)),
                        s = new Date(1 * f + this._get_fictional_event_length(f, this._drag_event._event_length, d))) : s = new Date(+f + v)) : (s = new Date(scheduler._max_date),
                        t._ignores && this.config.preserve_length && this._table_view ? (d._end_correction && (s = new Date(s.valueOf() - d._end_correction)),
                        s = new Date(1 * s - this._get_fictional_event_length(s, 0, d, !0)),
                        f = new Date(1 * s - this._get_fictional_event_length(s, this._drag_event._event_length, d, !0)),
                        this._ignores_detected && (f = scheduler.date.add(f, d.x_step, d.x_unit),
                        s = new Date(1 * s - this._get_fictional_event_length(s, 0, d, !0)),
                        s = scheduler.date.add(s, d.x_step, d.x_unit))) : f = new Date(+s - v))
                    }
                    var g = new Date(s - 1)
                }
                if (!this._table_view && !scheduler.config.all_timed && (!scheduler._get_section_view() && t.x != this._get_event_sday({
                    ...
                    s = scheduler.date.date_part(new Date(h)),
                    s.setHours(this.config.last_hour),
                    g = new Date(s - 1),
                    "move" == this._drag_mode && (f = new Date(+s - v));
                }
                if (this._table_view || g.getDate() == f.getDate() && g.getHours() < this.config.last_hour || scheduler._allow_dnd)
                    if (o.start_date = f,
                    o.end_date = new Date(s),
    ...
    scheduler._on_mouse_down = function(e, t) {
        if (2 != e.button && !this.config.readonly && !this._drag_mode) {
            ...
            case "dhx_event_resize":
                ...
                (t.className || "").indexOf("dhx_event_resize_end") < 0 ? scheduler._drag_from_start = !0 : scheduler._drag_from_start = !1;
                break;
            case "dhx_scale_holder":
            case "dhx_scale_holder_now":
            case "dhx_month_body":
            ...
            if (this._drag_mode && this._drag_id) {
                ...
                if (s && (this._drag_event._dhx_changed || !this._drag_event.start_date || a.start_date.valueOf() != this._drag_event.start_date.valueOf() || a.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                    ...
                    if (this.callEvent("onBeforeEventChanged", [a, e, n, this._drag_event]))
                        ...
                        n && this.config.edit_on_create) {
                            if (this.unselect(),
                            this._new_event = new Date,
                            this._table_view || this.config.details_on_create || !this.config.select)
                                return scheduler.callEvent("onDragEnd", [t, i, e]),
                                this.showLightbox(t);
                            this._drag_pos = !0,
                            this._select_id = this._edit_id = t
                        } else
                            this._new_event || this.callEvent(n ? "onEventAdded" : "onEventChanged", [t, this.getEvent(t)]);
                    else
                        n ? this.deleteEvent(a.id, !0) : (this._drag_event._dhx_changed = !1,
                        this._clear_temporary_properties(a, this._drag_event),
                        scheduler._lame_copy(a, this._drag_event),
                        this.updateEvent(a.id))
                }
                this._drag_pos && (this._drag_pos.has_moved || this._drag_pos === !0) && (this._drag_id = this._drag_mode = null ,
                this.render_view_data()),
                scheduler.callEvent("onDragEnd", [t, i, e])
            }
            this._drag_id = null ,
            this._drag_mode = null ,
            this._drag_pos = null
    ...
    scheduler.updateView = function(e, t) {
        ...
        var a = "dhx_multi_day";
        this._els[a] && (this._els[a][0].parentNode.removeChild(this._els[a][0]),
        this._els[a] = null ),
        this._mode = t,
        this._date = e,
        ...
        if (n)
            for (var r = 0; r < n.length; r++) {
                var d = n[r].className;
                d = d.replace(/ active/g, ""),
                n[r].getAttribute("name") == this._mode + "_tab" && (d += " active"),
                n[r].className = d
            }
        this.update_view(),
        "number" == typeof s && (this._els[i][0].scrollTop = s);
    }
    ,
    ...
    scheduler._render_x_header = function(e, t, i, s, a) {
        a = a || 0;
        var n = document.createElement("DIV");
        n.className = "dhx_scale_bar",
        this.templates[this._mode + "_scalex_class"] && (n.className += " " + this.templates[this._mode + "_scalex_class"](i));
        var r = this._cols[e] - 1;
        "month" == this._mode && 0 === e && this.config.left_border && (n.className += " dhx_scale_bar_border",
        t += 1),
        this.set_xy(n, r, this.xy.scale_height - 2, t, a),
        n.innerHTML = this.templates[this._mode + "_scale_date"](i, this._mode),
        s.appendChild(n)
    }
    ,
    scheduler._get_columns_num = function(e, t) {
        ...
        if (!scheduler._table_view) {
            ...
            s && (t = s(e)),
            i = Math.round((t.valueOf() - e.valueOf()) / 864e5)
        }
        return i
    }
    ,
    ...
    scheduler._calc_scale_sizes = function(e, t, i) {
        ...
        for (var n = a - this._ignores_detected, r = 0; a > r; r++)
            this._ignores[r] ? (this._cols[r] = 0,
            n++) : this._cols[r] = Math.floor(s / (n - r)),
            s -= this._cols[r],
            this._colsS[r] = (this._cols[r - 1] || 0) + (this._colsS[r - 1] || (this._table_view ? 0 : this.xy.scale_width + 2));
        this._colsS.col_length = a,
        this._colsS[a] = this._cols[a - 1] + this._colsS[a - 1] || 0;
    }
    ,
        ...
        for (var l = 0; d > l; l++) {
            ...
            !this._table_view) {
                var h = document.createElement("DIV")
                  , _ = "dhx_scale_holder";
                r.valueOf() == a.valueOf() && (_ = "dhx_scale_holder_now"),
                this._ignores_detected && this._ignores[l] && (_ += " dhx_scale_ignore"),
                h.className = _ + " " + this.templates.week_date_class(r, a),
                this._set_scale_col_size(h, this._cols[l], o),
                t.appendChild(h),
                this.callEvent("onScaleAdd", [h, r])
            }
            o += this._cols[l],
            r = this.date.add(r, 1, "day"),
            r = this.date.day_start(r)
        }
    }
    ,
    scheduler._reset_scale = function() {
        if (this.templates[this._mode + "_date"]) {
            ...
            this._dy_shift = 0,
            this.set_sizes();
            var a, n, r = this._get_timeunit_start(), d = scheduler._get_view_end();
            if (a = n = this._table_view ? scheduler.date.week_start(r) : r,
            this._min_date = a,
            this._els.dhx_cal_date[0].innerHTML = this.templates[this._mode + "_date"](r, d, this._mode),
            this._max_date = d,
            scheduler._render_scales(e, t),
            this._table_view)
                this._reset_month_scale(t, r, n);
            else if (this._reset_hours_scale(t, r, n),
            i.multi_day) {
                var o = "dhx_multi_day";
                ...
                this.set_xy(_, Math.max(this._colsS[this._colsS.col_length] + this.xy.scroll_width - 2, 0), 0, 0, h),
                t.parentNode.insertBefore(_, t);
                var c = _.cloneNode(!0);
                c.className = o + "_icon",
                c.style.visibility = "hidden",
                this.set_xy(c, this.xy.scale_width, 0, 0, h),
                _.appendChild(c),
                this._els[o] = [_, c],
    ...
    scheduler._reset_hours_scale = function(e, t, i) {
        ...
        for (var a = new Date(1980,1,1,this.config.first_hour,0,0), n = 1 * this.config.first_hour; n < this.config.last_hour; n++) {
            ...
            r.className = "dhx_scale_hour",
            r.style.height = this.config.hour_size_px - (this._quirks ? 0 : 1) + "px";
            var d = this.xy.scale_width;
            this.config.left_border && (d -= 1,
            r.className += " dhx_scale_hour_border"),
            r.style.width = d + "px",
            r.innerHTML = scheduler.templates.hour_scale(a),
            s.appendChild(r),
    ...
    scheduler._process_ignores = function(e, t, i, s, a) {
        ...
        if (n)
            for (var r = new Date(e), d = 0; t > d; d++)
                n(r) && (this._ignores_detected += 1,
                this._ignores[d] = !0,
                a && t++),
                r = scheduler.date.add(r, s, i),
                scheduler.date[i + "_start"] && (r = scheduler.date[i + "_start"](r))
    }
    ,
    scheduler._render_month_scale = function(e, t, i) {
        function s(e) {
            var t = scheduler._colsS.height;
            return void 0 !== scheduler._colsS.heights[e + 1] && (t = scheduler._colsS.heights[e + 1] - (scheduler._colsS.heights[e] || 0)),
            t
        }
        ...
        for (var d = Math.ceil(Math.round((a.valueOf() - i.valueOf()) / 864e5) / 7), o = [], l = 0; 7 >= l; l++) {
            ...
            0 === l && this.config.left_border && (h -= 1),
            o[l] = h + "px"
        }
        var _ = 0
        ...
        for (var g = [], l = 0; d > l; l++) {
            ...
            for (var v = Math.max(s(l) - scheduler.xy.month_head_height, 0), m = 0; 7 > m; m++) {
                ...
                f.appendChild(p);
                var x = "";
                t > i ? x = "dhx_before" : i >= a ? x = "dhx_after" : i.valueOf() == r.valueOf() && (x = "dhx_now"),
                this._ignores_detected && this._ignores[m] && (x += " dhx_scale_ignore"),
                p.className = x + " " + this.templates.month_date_class(i, r);
                var b = "dhx_month_body"
                  , y = "dhx_month_head";
                if (0 === m && this.config.left_border && (b += " dhx_month_body_border",
                y += " dhx_month_head_border"),
                this._ignores_detected && this._ignores[m])
                    p.appendChild(document.createElement("div")),
                    p.appendChild(document.createElement("div"));
                else {
                    var w = document.createElement("DIV");
                    w.className = y,
                    w.innerHTML = this.templates.month_day(i),
                    p.appendChild(w);
                ...
                i.getDate() - E > 1 && (i = new Date(i.getFullYear(),i.getMonth(),E + 1,12,0))
            }
            scheduler._colsS.heights[l] = _,
            _ += s(l)
        }
        this._min_date = n,
        this._max_date = i,
        ...
        e.appendChild(c),
        this._scales = {};
        for (var M = e.getElementsByTagName("div"), l = 0; l < g.length; l++) {
            var e = M[2 * l + 1]
              , k = g[l];
            this._scales[+k] = e
        }
    ...
    scheduler._reset_month_scale = function(e, t, i) {
        ...
        return this._colsS.height = r + this.xy.month_head_height,
        this._colsS.heights = [],
        scheduler._render_month_scale(e, t, i)
    }
    ,
    ...
    scheduler._lame_clone = function(e, t) {
        ...
        if (e && "object" == typeof e) {
            for (a = {},
            s = [Array, Date, Number, String, Boolean],
            i = 0; i < s.length; i++)
                e instanceof s[i] && (a = i ? new s[i](e) : new s[i]);
            t.push(e, a);
            for (i in e)
                Object.prototype.hasOwnProperty.apply(e, [i]) && (a[i] = scheduler._lame_clone(e[i], t))
        }
        return a || e
    }
    ,
    ...
    scheduler._focus = function(e, t) {
        e && e.focus && (this.config.touch ? window.setTimeout(function() {
            e.focus()
        }, 100) : (t && e.select && e.select(),
        e.focus()))
    }
    ,
    scheduler._get_real_event_length = function(e, t, i) {
        var s, a = t - e, n = i._start_correction + i._end_correction || 0, r = this["ignore_" + this._mode], d = 0;
        i.render ? (d = this._get_date_index(i, e),
        s = this._get_date_index(i, t)) : s = Math.round(a / 60 / 60 / 1e3 / 24);
        for (var o = !0; s > d; ) {
            var l = scheduler.date.add(t, -i.x_step, i.x_unit);
            r && r(t) && (!o || o && r(l)) ? a -= t - l : (o = !1,
            a -= n),
            t = l,
            s--
        }
    ...
    scheduler._get_fictional_event_length = function(e, t, i, s) {
        ...
        var l, h = new Date(1 * e + t * n), _ = this["ignore_" + this._mode], c = 0;
    ...
    scheduler.date = {
        ...
        _add_days: function(e, t) {
            ...
            if (i.setDate(i.getDate() + t),
            t == Math.round(t) && t > 0) {
                var s = +i - +e
                  , a = s % 864e5;
                if (a && e.getTimezoneOffset() == i.getTimezoneOffset()) {
                    var n = a / 36e5;
                    i.setTime(i.getTime() + 60 * (24 - n) * 60 * 1e3)
                }
            }
        ...
        str_to_date: function(e, t) {
            for (var i = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", s = e.match(/%[a-zA-Z]/g), a = 0; a < s.length; a++)
                switch (s[a]) {
                case "%j":
                case "%d":
                    i += "set[2]=temp[" + a + "]||1;";
    ...
    scheduler.addEvent = function(e, t, i, s, a) {
        ...
        n.text = i,
        n.id = s),
        n.id = n.id || scheduler.uid(),
        n.text = n.text || "",
        "string" == typeof n.start_date && (n.start_date = this.templates.api_date(n.start_date)),
        "string" == typeof n.end_date && (n.end_date = this.templates.api_date(n.end_date));
        ...
        return this._events[n.id] = n,
        this.event_updated(n),
        this._loading || this.callEvent(d ? "onEventAdded" : "onEventChanged", [n.id, n]),
        n.id
    }
    ,
    ...
    function() {
        ...
        , i = function(e) {
            return function(t, i) {
                ...
                scheduler.event_updated(s, !0)
            }
        }
        , s = 0; s < e.length; s += 2)
            scheduler["getEvent" + e[s + 1]] = t(e[s]),
            scheduler["setEvent" + e[s + 1]] = i(e[s])
    }(),
    ...
    scheduler.is_visible_events = function(e) {
        ...
        if (t) {
            var i = e.start_date.getHours()
              , s = e.end_date.getHours() + e.end_date.getMinutes() / 60
              , a = this.config.last_hour
              , n = this.config.first_hour
              , r = this._table_view || !((s > a || n > s) && (i >= a || n > i));
            if (r)
                return !0;
    ...
    scheduler.render_view_data = function(e, t) {
        ...
        if (this.config.multi_day && !this._table_view) {
            for (var a = [], n = [], i = 0; i < e.length; i++)
                this._is_main_area_event(e[i]) ? a.push(e[i]) : n.push(e[i]);
            this._rendered_location = this._els.dhx_multi_day[0],
            this._table_view = !0,
            this.render_data(n, t),
            this._table_view = !1,
            this._rendered_location = this._els.dhx_cal_data[0],
            this._table_view = !1,
            this.render_data(a, t)
        } else
            this._rendered_location = this._els.dhx_cal_data[0],
    ...
    scheduler._render_month_link = function(e) {
        for (var t = this._rendered_location, i = this._lame_clone(e), s = e._sday; s < e._eday; s++) {
            ...
            n = a.add(n, i._sweek, "week"),
            n = a.add(n, i._sday, "day");
            ...
            l.style.left = d.x + "px",
            l.style.width = o + "px",
            l.innerHTML = scheduler.templates.month_events_link(n, r),
    ...
    scheduler._recalculate_timed = function(e) {
        if (e) {
            var t;
            t = "object" != typeof e ? this._events[e] : e,
            t && (t._timed = scheduler.isOneDayEvent(t))
        }
    }
    ,
    ...
    scheduler._pre_render_events = function(e, t) {
        ...
        this._table_view)
            if (t)
                    ...
                    for (var d = 0; d < r.rows.length; d++) {
                        ...
                        if (a[d] * i > l) {
                            ...
                            for (var _ = 0; _ < o.length; _++)
                                o[_].childNodes[1].style.height = h + "px"
                        }
                        a[d] = (a[d - 1] || 0) + scheduler._get_first_visible_cell(o).offsetHeight
                    }
                    if (a.unshift(0),
                    r.parentNode.offsetHeight < r.parentNode.scrollHeight && !scheduler._colsS.scroll_fix && scheduler.xy.scroll_width) {
                        var c = scheduler._colsS
                          , u = c[c.col_length]
                          , g = c.heights.slice();
                        u -= scheduler.xy.scroll_width || 0,
                        this._calc_scale_sizes(u, this._min_date, this._max_date),
                        scheduler._colsS.heights = g,
                ...
                e.length || -1 == a[0]) {
                    var f = (r.parentNode.childNodes,
                    (a[0] + 1) * i + 1)
                      , v = f
                      , m = f + "px";
                    this.config.multi_day_height_limit && (v = Math.min(f, this.config.multi_day_height_limit),
                    m = v + "px"),
                    n.style.top = this._els.dhx_cal_navline[0].offsetHeight + this._els.dhx_cal_header[0].offsetHeight + v + "px",
                    n.style.height = this._obj.offsetHeight - parseInt(n.style.top, 10) - (this.xy.margin_top || 0) + "px";
                    var p = this._els.dhx_multi_day[0];
                    p.style.height = m,
                    p.style.visibility = -1 == a[0] ? "hidden" : "visible";
                    ...
                    a[0] = 0,
                    v != f && (n.style.top = parseInt(n.style.top) + 2 + "px",
    ...
    scheduler._pre_render_events_line = function(e, t) {
        ...
        for (var a = 0; a < e.length; a++) {
            ...
            this._ignores[n._sday])
                e.splice(a, 1),
                a--;
            else {
                if (i[n._sday] || (i[n._sday] = []),
                !t) {
                    n._inner = !1;
                    ...
                    !g)
                        if (h.length)
                            ...
                            n._sorder = 0;
                    h.splice(u, u == h.length ? 0 : 1, n),
                    h.length > (h.max_count || 0) ? (h.max_count = h.length,
                    n._count = h.length) : n._count = n._count ? n._count : 1
                }
                (o < this.config.first_hour || l >= this.config.last_hour) && (s.push(n),
                e[a] = n = this._copy_event(n),
                o < this.config.first_hour && (n.start_date.setHours(this.config.first_hour),
                n.start_date.setMinutes(0)),
                l >= this.config.last_hour && (n.end_date.setMinutes(0),
                n.end_date.setHours(this.config.last_hour)),
                n.start_date > n.end_date || o == this.config.last_hour) && (e.splice(a, 1),
                a--)
            }
        }
        if (!t) {
            for (var a = 0; a < e.length; a++)
                e[a]._count = i[e[a]._sday].max_count;
            for (var a = 0; a < s.length; a++)
                s[a]._count = i[s[a]._sday].max_count
        }
        return e
    }
    ,
    ...
    scheduler._pre_render_events_table = function(e, t) {
        this._time_order(e);
        for (var i, s = [], a = [[], [], [], [], [], [], []], n = this._colsS.heights, r = this._cols.length, d = {}, o = 0; o < e.length; o++) {
            var l = e[o]
              , h = l.id;
            d[h] || (d[h] = {
                first_chunk: !0,
            ...
            c = this._min_date),
            u > this._max_date && (_.last_chunk = !1,
            u = this._max_date);
            ...
            !this._ignores[l._sday] || !l._timed) {
                ...
                l._eday = f % r || r,
                l._length = f - g,
                l._sweek = Math.floor((this._correct_shift(c.valueOf(), 1) - this._min_date.valueOf()) / (864e5 * r));
                var v, m = a[l._sweek];
                ...
                l._sday + l._length <= r)
                    ...
                    s.push(l),
                    m[v] = l,
                    n[l._sweek] = m.length - 1,
                    l._first_chunk = _.first_chunk,
                    l._last_chunk = _.last_chunk;
                else {
                    ...
                    p._sweek = l._sweek,
                    p._sorder = l._sorder,
                    p.end_date = this.date.add(c, p._length, "day"),
                    p._first_chunk = _.first_chunk,
                    _.first_chunk && (_.first_chunk = !1),
                    s.push(p),
                    m[v] = p,
                    i = p.end_date,
                    n[l._sweek] = m.length - 1,
    ...
    scheduler.clear_event = function(e) {
        this.for_rendered(e, function(e, t) {
            ...
            scheduler._rendered.splice(t, 1);
        })
    }
    ,
    ...
    scheduler.render_event = function(e) {
        ...
        if (!(e._sday < 0)) {
            ...
            if (s) {
                ...
                if (this._rendered.push(g),
                s.appendChild(g),
                h = h + parseInt(s.style.left, 10) + i,
                this._edit_id == e.id) {
                    g.style.zIndex = 1,
                    l = Math.max(l - 4, scheduler.xy.editor_width),
                    g = document.createElement("DIV"),
                    g.setAttribute("event_id", e.id),
                    this.set_xy(g, l, r - 20, h, n + 14),
                    g.className = "dhx_cal_event dhx_cal_editor";
                    var f = scheduler.templates.event_class(e.start_date, e.end_date, e);
                    f && (g.className += " " + f);
                    var v = document.createElement("DIV");
                    this.set_xy(v, l - 6, r - 26),
                    v.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;",
                    g.appendChild(v),
                    this._els.dhx_cal_data[0].appendChild(g),
                    this._rendered.push(g),
                    v.innerHTML = "<textarea class='dhx_cal_editor'>" + e.text + "</textarea>",
                    this._quirks7 && (v.firstChild.style.height = r - 12 + "px"),
                    this._editor = v.firstChild,
                    this._editor.onkeydown = function(e) {
                        if ((e || event).shiftKey)
                            return !0;
                        var t = (e || event).keyCode;
                        t == scheduler.keys.edit_save && scheduler.editStop(!0),
                        t == scheduler.keys.edit_cancel && scheduler.editStop(!1)
                    }
                    ,
    ...
    scheduler._render_v_bar = function(e, t, i, s, a, n, r, d, o) {
        ...
        if (!o && scheduler.renderEvent(v, e, s, a, r, d))
            return v;
        v = l.firstChild;
        var m = '<div class="dhx_event_move dhx_header" style=" width:' + (s - 6) + "px;" + u + '" >&nbsp;</div>';
        m += '<div class="dhx_event_move dhx_title" style="' + u + g + '">' + r + "</div>",
        m += '<div class="dhx_body" style=" width:' + (s - (this._quirks ? 4 : 14)) + "px; height:" + (a - (this._quirks ? 20 : 30) + 1) + "px;" + u + g + '">' + d + "</div>";
        var p = "dhx_event_resize dhx_footer";
        return o && (p = "dhx_resize_denied " + p),
        m += '<div class="' + p + '" style=" width:' + (s - 8) + "px;" + (o ? " margin-top:-1px;" : "") + u + g + '" ></div>',
        v.innerHTML = m,
        v
    }
    ,
    ...
    scheduler.locate_holder_day = function(e, t) {
        ...
        return t && this.date.time_part(e) && i++,
        i
    }
    ,
    ...
    scheduler.render_event_bar = function(e) {
        ...
        if (n) {
            ...
            (!e._timed || d) && (u = "dhx_cal_event_line"),
            l && (u += " dhx_cal_event_line_start"),
            h && (u += " dhx_cal_event_line_end"),
            _ && (r += "<div class='dhx_event_resize dhx_event_resize_start'></div>"),
            c && (r += "<div class='dhx_event_resize dhx_event_resize_end'></div>");
            ...
            d && (p += r),
            "month" == scheduler.getState().mode && (e = scheduler.getEvent(e.id)),
            e._timed && (p += scheduler.templates.event_bar_date(e.start_date, e.end_date, e)),
            p += scheduler.templates.event_bar_text(e.start_date, e.end_date, e) + "</div>",
            p += "</div>",
            o.innerHTML = p,
    ...
    scheduler.showEvent = function(e, t) {
        ...
        if (t = t || scheduler._mode,
        i && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [i, t]))) {
            ...
            i.textColor = scheduler.config.displayed_event_text_color),
            scheduler.setCurrentView(new Date(i.start_date), t),
            i.color = n,
            i.textColor = r,
            scheduler.config.scroll_hour = s,
            scheduler.config.preserve_scroll = a,
            scheduler.matrix && scheduler.matrix[t]) {
    ...
    scheduler._append_drag_marker = function(e) {
        if (!e.parentNode) {
            var t = scheduler._els.dhx_cal_data[0]
              , i = t.lastChild;
            i.className && i.className.indexOf("dhx_scale_holder") < 0 && i.previousSibling && (i = i.previousSibling),
            i && 0 === i.className.indexOf("dhx_scale_holder") && i.appendChild(e)
        }
    }
    ,
    ...
    scheduler._load = function(e, t) {
        if (e = e || this._load_url) {
            ...
            this._load_mode) {
                ...
                i = t;
                for (var a = !0; i < this._max_date; )
                    i = this.date.add(i, 1, this._load_mode),
                    this._loaded[s(t)] && a ? t = this.date.add(t, 1, this._load_mode) : a = !1;
                var n = i;
                do
                    i = n,
                    n = this.date.add(i, -1, this._load_mode);
                while (n > t && this._loaded[s(n)]);if (t >= i)
                    return !1;
    ...
    scheduler.on_load = function(e) {
        ...
        if (this._process && "xml" != this._process)
            ...
            t = this._magic_parser(e),
            t || (i = !0);
        i && (this.callEvent("onLoadError", [e.xmlDoc]),
        t = []),
        scheduler._process_loading(t),
    ...
    scheduler._init_event = function(e) {
        ...
        e.start_date = scheduler._init_date(e.start_date),
        e.end_date = scheduler._init_date(e.end_date)
    }
    ,
    ...
    scheduler.json.parse = function(data) {
        "string" == typeof data && (scheduler._temp = eval("(" + data + ")"),
        ...
        for (var key in collections)
            if (collections.hasOwnProperty(key)) {
                ...
                if (!arr)
                    continue;arr.splice(0, arr.length);
    ...
    ,
    scheduler._userdata = {},
    scheduler._magic_parser = function(e) {
        var t;
        if (!e.getXMLTopNode) {
    ...
    scheduler.attachEvent("onXLE", function() {
        ...
        e && "object" == typeof e && (this._obj.removeChild(e),
    ...
    scheduler.ical = {
        ...
        parse_param: function(e, t) {
            ...
            if (-1 != i) {
                ...
                "summary" == s ? s = "text" : "dtstart" == s ? (s = "start_date",
                a = this.parse_date(a, 0, 0)) : "dtend" == s && (s = "end_date",
    ...
    scheduler.form_blocks = {
        ...
        select: {
            render: function(e) {
                for (var t = (e.height || "23") + "px", i = "<div class='dhx_cal_ltext' style='height:" + t + ";'><select style='width:100%;'>", s = 0; s < e.options.length; s++)
                    i += "<option value='" + e.options[s].key + "'>" + e.options[s].label + "</option>";
                return i += "</select></div>";
            },
            set_value: function(e, t, i, s) {
                var a = e.firstChild;
                !a._dhx_onchange && s.onchange && (a.onchange = s.onchange,
                a._dhx_onchange = !0),
                "undefined" == typeof t && (t = (a.options[0] || {}).value),
                a.value = t || ""
            },
            get_value: function(e, t) {
        ...
        time: {
            render: function(e) {
                ...
                var t = e.time_format
                  ...
                  , a = 1440
                  , n = 0;
                scheduler.config.limit_time_select && (a = 60 * i.last_hour + 1,
                n = 60 * i.first_hour,
                s.setHours(i.first_hour));
                for (var r = "", d = 0; d < t.length; d++) {
                    ...
                    case "%Y":
                        ...
                        r += "<select>";
                        for (var l = s.getFullYear() - 5, h = 0; 10 > h; h++)
                    ...
                    case "%H:%i":
                        ...
                        for (e._time_values = []; a > h; ) {
                            ...
                            r += "<option value='" + h + "'>" + c + "</option>",
                            e._time_values.push(h),
                            s.setTime(s.valueOf() + 60 * this.config.time_step * 1e3);
            ...
            set_value: function(e, t, i, s) {
                function a(e, t, i) {
                    ...
                    e[t + l[0]].value = d ? n : r,
                    d || r || (e[t + l[0]].selectedIndex = -1),
                    e[t + l[1]].value = i.getDate(),
                    e[t + l[2]].value = i.getMonth(),
                    e[t + l[3]].value = i.getFullYear()
                }
                var n, r, d = scheduler.config, o = e.getElementsByTagName("select"), l = s._time_format_order;
                if (d.full_day) {
                    if (!e._full_day) {
                        ...
                        e.previousSibling.innerHTML = h,
                        e._full_day = !0
                    }
                    var _ = e.previousSibling.getElementsByTagName("input")[0];
                    _.checked = 0 === scheduler.date.time_part(i.start_date) && 0 === scheduler.date.time_part(i.end_date),
                    o[l[0]].disabled = _.checked,
                    o[l[0] + o.length / 2].disabled = _.checked,
                    _.onclick = function() {
                        if (_.checked) {
                            var t = {};
                            scheduler.form_blocks.time.get_value(e, t, s),
                            n = scheduler.date.date_part(t.start_date),
                            r = scheduler.date.date_part(t.end_date),
                            (+r == +n || +r >= +n && (0 !== i.end_date.getHours() || 0 !== i.end_date.getMinutes())) && (r = scheduler.date.add(r, 1, "day"));
                        } else
                            n = null ,
                            r = null ;
                        o[l[0]].disabled = _.checked,
                        o[l[0] + o.length / 2].disabled = _.checked,
                        a(o, 0, n || i.start_date),
                        a(o, 4, r || i.end_date)
                    }
                }
                if (d.auto_end_date && d.event_duration)
                    for (var c = function() {
                        n = new Date(o[l[3]].value,o[l[2]].value,o[l[1]].value,0,o[l[0]].value),
                        r = new Date(n.getTime() + 60 * scheduler.config.event_duration * 1e3),
                        a(o, 4, r)
                    }
                    , u = 0; 4 > u; u++)
                        o[u].onchange = c;
            ...
            get_value: function(e, t, i) {
                ...
                t.end_date = new Date(s[a[3] + 4].value,s[a[2] + 4].value,s[a[1] + 4].value,0,s[a[0] + 4].value),
                !s[a[3]].value || !s[a[3] + 4].value) {
                    var n = this.getEvent(this._lightbox_id);
                    n && (t.start_date = n.start_date,
                    t.end_date = n.end_date)
                }
    ...
    scheduler.showCover = function(e) {
        if (e) {
            ...
            t ? e.style.top = Math.round(t + Math.max((s - e.offsetHeight) / 2, 0)) + "px" : e.style.top = Math.round(Math.max((s - e.offsetHeight) / 2, 0) + 9) + "px",
            document.documentElement.scrollWidth > document.body.offsetWidth ? e.style.left = Math.round(i + (document.body.offsetWidth - e.offsetWidth) / 2) + "px" : e.style.left = Math.round((document.body.offsetWidth - e.offsetWidth) / 2) + "px";
        }
        this.show_cover()
    }
    ,
            ...
            t && t.className)
                ...
                default:
                    if (t.getAttribute("dhx_button"))
                        ...
                        var s, a, n;
                        -1 != t.className.indexOf("dhx_custom_button") && (-1 != t.className.indexOf("dhx_custom_button_") ? (s = t.parentNode.getAttribute("index"),
                        n = t.parentNode.parentNode) : (s = t.getAttribute("index"),
                        n = t.parentNode,
                        t = t.firstChild)),
                        s && (a = scheduler.form_blocks[scheduler.config.lightbox.sections[s].type],
    ...
    scheduler.setLightboxSize = function() {
        ...
        if (e) {
            ...
            e.style.height = t.scrollHeight + scheduler.xy.lightbox_additional_height + "px",
            t.style.height = t.scrollHeight + "px"
        }
    }
    ,
    ...
    scheduler._ready_to_dnd = function(e) {
        var t = scheduler.getLightbox();
        scheduler._lb_start = [parseInt(t.style.left, 10), parseInt(t.style.top, 10)],
        scheduler._dnd_start_lb = e && e.target ? [e.pageX, e.pageY] : [event.clientX, event.clientY]
    }
    ,
    scheduler._finish_dnd = function() {
        scheduler._lb_start && (scheduler._lb_start = scheduler._dnd_start_lb = !1,
    ...
    scheduler.getLightbox = function() {
        if (!this._lightbox) {
            ...
            scheduler.config.wide_form && (e.className += " dhx_cal_light_wide"),
            scheduler.form_blocks.recurring && (e.className += " dhx_cal_light_rec"),
            ...
            for (var s = 0; s < i.length; s++)
                t += "<div class='dhx_btn_set dhx_right_btn_set " + i[s] + "_set' style='float:right;'><div dhx_button='1' class='" + i[s] + "'></div><div>" + scheduler.locale.labels[i[s]] + "</div></div>";
            t += "</div>",
            e.innerHTML = t,
            scheduler.config.drag_lightbox && (e.firstChild.onmousedown = scheduler._ready_to_dnd,
            ...
            for (var s = 0; s < a.length; s++) {
                ...
                if (n) {
                    ...
                    var r = "";
                    a[s].button && (r = "<div class='dhx_custom_button' index='" + s + "'><div class='dhx_custom_button_" + a[s].button + "'></div><div>" + this.locale.labels["button_" + a[s].button] + "</div></div>"),
                    this.config.wide_form && (t += "<div class='dhx_wrap_section'>");
                    var d = this.locale.labels["section_" + a[s].name];
                    "string" != typeof d && (d = a[s].name),
                    t += "<div id='" + a[s].id + "' class='dhx_cal_lsection'>" + r + d + "</div>" + n.render.call(this, a[s]),
                    t += "</div>"
                }
            }
    ...
    scheduler._init_touch_events = function() {
        ...
        this.config.touch && (this.xy.scroll_width = 0,
    ...
    scheduler._touch_events = function(e, t, i) {
        ...
        function a(e, t, i, s) {
            if (e && t) {
                for (var a = e.target; a && a != scheduler._obj; )
                    a = a.parentNode;
                if (a == scheduler._obj) {
        ...
        function n(e) {
            ...
            "create" == t && i && (scheduler.render_view_data = function() {
                for (var e = scheduler.getState().drag_id, t = scheduler.getEvent(e), s = i.y_property, a = scheduler.getEvents(t.start_date, t.end_date), n = 0; n < a.length; n++)
                    a[n][s] != t[s] && (a.splice(n, 1),
                    n--);
                t._sorder = a.length - 1,
                t._count = a.length,
                this.render_data([t], scheduler.getState().mode)
            }
            ),
            scheduler._on_mouse_move(e),
            "create" == t && i && (scheduler.render_view_data = s)
        }
        function r(e) {
            scheduler._hide_global_tip(),
            h && (scheduler._on_mouse_up(t(e || event)),
            scheduler._temp_touch_block = !1),
        ...
        s(document.body, e[0], function(e) {
            if (!i(e)) {
                ...
                if (o = t(e),
                c)
                    return o ? void ((d.target != o.target || Math.abs(d.pageX - o.pageX) > 5 || Math.abs(d.pageY - o.pageY) > 5) && (_ = !0,
                    clearTimeout(l))) : void (_ = !0)
            }
        }),
        s(this._els.dhx_cal_data[0], "scroll", r),
        s(this._els.dhx_cal_data[0], "touchcancel", r),
        s(this._els.dhx_cal_data[0], "contextmenu", function(e) {
            return c ? (e && e.preventDefault && e.preventDefault(),
            (e || event).cancelBubble = !0,
            !1) : void 0
        }),
        s(this._obj, e[1], function(e) {
            if (!i(e)) {
                var s;
                if (h = _ = !1,
                c = !0,
                ...
                var a = new Date;
                if (!_ && !h && 250 > a - u)
                    return scheduler._click.dhx_cal_data(s),
                    window.setTimeout(function() {
                        scheduler._on_dbl_click(s)
                    }, 50),
                    e.preventDefault && e.preventDefault(),
                    e.cancelBubble = !0,
                    scheduler._block_next_stop = !0,
                    !1;
                if (u = a,
                !_ && !h && scheduler.config.touch_drag) {
                    ...
                    if (n && r && n == r && n != g)
                        ...
                        e.cancelBubble = !0,
                        scheduler._ignore_next_click = !1,
                        scheduler._click.dhx_cal_data(s),
                        d = s,
                        !1;
                    l = setTimeout(function() {
                        h = !0;
                        var e = d.target;
                        e && e.className && -1 != e.className.indexOf("dhx_body") && (e = e.previousSibling),
                        scheduler._on_mouse_down(d, e),
                        scheduler._drag_mode && "create" != scheduler._drag_mode && scheduler.for_rendered(scheduler._drag_id, function(e, t) {
                            e.style.display = "none",
                            scheduler._rendered.splice(t, 1)
                        }),
        ...
        s(this._els.dhx_cal_data[0], e[2], function(e) {
            return i(e) ? void 0 : (h || a(d, o, 200, 100),
            h && (scheduler._ignore_next_click = !0),
            r(e),
            scheduler._block_next_stop ? (scheduler._block_next_stop = !1,
            e.preventDefault && e.preventDefault(),
            e.cancelBubble = !0,
            !1) : void 0)
        }),
    ...
    scheduler._dp_init = function(e) {
        ...
        this._dp_hook_delete = function(t, i) {
            ...
            this.changeEventId(t, i)),
            this.deleteEvent(i, !0)) : void 0
        }
        ,
        ...
        this.attachEvent("onConfirmedBeforeEventDelete", function(t) {
            if (this._validId(t)) {
                ...
                !0) : "deleted" == i ? !1 : "true_deleted" == i ? !0 : (e.setUpdated(t, !0, "deleted"),
                !1)
            }
        }),
        ...
        e._objToJson = function(t, i, s) {
            ...
            i = i || {};
            for (var a in t)
                0 !== a.indexOf("_") && (t[a] && t[a].getUTCFullYear ? i[s + a] = this.obj.templates.xml_format(t[a]) : t[a] && "object" == typeof t[a] ? e._objToJson(t[a], i, s + a + ".") : i[s + a] = t[a]);
            return i
        }
        ,
        ...
        e.attachEvent("updateCallback", scheduler._update_callback),
    ...
    scheduler._update_callback = function(e, t) {
        ...
        i.start_date = scheduler.templates.xml_date(i.start_date),
        i.end_date = scheduler.templates.xml_date(i.end_date),
        scheduler.addEvent(i),
        scheduler._add_rec_marker && scheduler.setCurrentView();
    }
    ,
    ...
    scheduler._configure = function(e, t, i) {
        for (var s in t)
            "undefined" == typeof e[s] && (e[s] = t[s][i])
    }
    ,
    scheduler._skin_init = function() {
        ...
        var s = 0;
        if (!scheduler.skin || "classic" !== scheduler.skin && "glossy" !== scheduler.skin || (s = 1),
        this._configure(scheduler.config, scheduler._skin_settings, s),
        this._configure(scheduler.xy, scheduler._skin_xy, s),
        "flat" === scheduler.skin && (scheduler.xy.scale_height = 35,
        scheduler.templates.hour_scale = function(e) {
            var t = e.getMinutes();
            t = 10 > t ? "0" + t : t;
        ...
        !s) {
            ...
            a && (a.padding = 14),
            scheduler.templates.event_bar_date = function(e, t, i) {
            ...
            scheduler.attachEvent("onTemplatesReady", function() {
                ...
                if (scheduler.templates.month_day = function(i) {
                    if ("month" == this._mode) {
                        var s = e(i);
                        return 1 == i.getDate() && (s = scheduler.locale.date.month_full[i.getMonth()] + " " + s),
                        +i == +scheduler.date.date_part(new Date) && (s = scheduler.locale.labels.dhx_cal_today_button + " " + s),
                        s
                    }
                ...
                scheduler.config.fix_tab_position) {
                    for (var i = scheduler._els.dhx_cal_navline[0].getElementsByTagName("div"), s = null , a = 211, n = 0; n < i.length; n++) {
                        ...
                        if (d)
                            switch (r.style.right = "auto",
                            d) {
                            case "day_tab":
                                r.style.left = "14px",
                                r.className += " dhx_cal_tab_first";
                                break;
                            case "week_tab":
                                r.style.left = "75px";
                                break;
                            case "month_tab":
                                r.style.left = "136px",
                                r.className += " dhx_cal_tab_last";
                                break;
                            default:
                                r.style.left = a + "px",
                                r.className += " dhx_cal_tab_standalone",
                                a = a + 14 + r.offsetWidth
                            }
                        else
                            0 === (r.className || "").indexOf("dhx_minical_icon") && r.parentNode == scheduler._els.dhx_cal_navline[0] && (s = r)
                    }
                    s && (s.style.left = a + "px")
                }
            }),
    ...
    function() {
        ...
        var t = scheduler.setCurrentView
          ...
          , n = function(t, n) {
            ...
            a = setTimeout(function() {
                ...
                r.callEvent("onViewChange", [r._mode, r._date]),
                window.clearTimeout(s),
                a = 0)
        ...
        scheduler.attachEvent("onSchedulerReady", function() {
            scheduler.config.delay_render ? (scheduler.setCurrentView = n,
            scheduler.updateView = r) : (scheduler.setCurrentView = t,
            scheduler.updateView = i)
        })
    }();
    for (var i = 0; i < Scheduler._schedulerPlugins.length; i++)
        Scheduler._schedulerPlugins[i](scheduler);
    return scheduler._internal_id = Scheduler._seed++,
    Scheduler.$syncFactory && Scheduler.$syncFactory(scheduler),
    scheduler
}
,
window.scheduler = Scheduler.getSchedulerInstance(),
dhtmlx && dhtmlx.attaches && (dhtmlx.attaches.attachScheduler = function(e, t, i, s) {
    ...
    this.vs[this.av].sched = s,
    this.vs[this.av].schedId = a.id,
    s.setSizes = s.updateView,
